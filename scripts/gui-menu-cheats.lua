...
local personal_cheats_menu_gui_data = {
    ...
    cheats_gui_data = {
        cheat_mode = {
            ...
            label_tooltip = {"gui.creative-mode_cheat-mode-tooltip",
        ...
        invincible_player = {
            ...
            label_tooltip = {"gui.creative-mode_invincible-player-tooltip",
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
        ...
        repair_mined_item = {
            ...
            label_tooltip = {"gui.creative-mode_repair-mined-item-tooltip",
        ...
        reach_distance = {
            ...
            label_tooltip = {"gui.creative-mode_reach-distance-tooltip", cheats.default_cheat_values.reach_distance,
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        build_distance = {
            ...
            label_tooltip = {"gui.creative-mode_build-distance-tooltip", cheats.default_cheat_values.reach_distance,
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        resource_reach_distance = {
            ...
            label_tooltip = {"gui.creative-mode_resource-reach-distance-tooltip",
        ...
        item_drop_distance = {
            ...
            label_tooltip = {"gui.creative-mode_item-drop-distance-tooltip", cheats.default_cheat_values.reach_distance,
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        item_pickup_distance = {
            ...
            label_tooltip = {"gui.creative-mode_item-pickup-distance-tooltip",
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        loot_pickup_distance = {
            ...
            label_tooltip = {"gui.creative-mode_loot-pickup-distance-tooltip",
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        mining_speed = {
            ...
            label_tooltip = {"gui.creative-mode_mining-speed-tooltip", cheats.default_cheat_values.mining_speed,
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        running_speed = {
            ...
            label_tooltip = {"gui.creative-mode_running-speed-tooltip", cheats.default_cheat_values.running_speed,
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        crafting_speed = {
            ...
            label_tooltip = {"gui.creative-mode_crafting-speed-tooltip", {"gui.creative-mode_no-effect-in-cheat-mode"},
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        inventory_bonus = {
            ...
            label_tooltip = {"gui.creative-mode_inventory-bonus-tooltip",
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        health_bonus = {
            ...
            label_tooltip = {"gui.creative-mode_health-bonus-tooltip",
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"},
                             {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
        ...
        god_mode = {
            ...
            label_tooltip = {"gui.creative-mode_god-mode-tooltip",
                             {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}},
    ...
    get_button_actual_target_function = function(player, button)
        local player_index = string.match(button.name,
                                 creative_mode_defines.match_patterns.gui.personal_cheats_target_index_button)
...
local team_cheats_menu_gui_data = {
    ...
    cheats_gui_data = {
        ...
        reach_distance = {
            ...
            label_tooltip = {"gui.creative-mode_team-reach-distance-tooltip",
        ...
        build_distance = {
            ...
            label_tooltip = {"gui.creative-mode_team-build-distance-tooltip",
                             {"gui.creative-mode_no-effect-in-god-mode"}},
        ...
        resource_reach_distance = {
            ...
            label_tooltip = {"gui.creative-mode_team-resource-reach-distance-tooltip",
                             {"gui.creative-mode_no-effect-in-god-mode"}},
        ...
        item_drop_distance = {
            ...
            label_tooltip = {"gui.creative-mode_team-item-drop-distance-tooltip",
                             {"gui.creative-mode_no-effect-in-god-mode"}},
        ...
        item_pickup_distance = {
            ...
            label_tooltip = {"gui.creative-mode_team-item-pickup-distance-tooltip",
                             {"gui.creative-mode_no-effect-in-god-mode"}},
        ...
        loot_pickup_distance = {
            ...
            label_tooltip = {"gui.creative-mode_team-loot-pickup-distance-tooltip",
                             {"gui.creative-mode_no-effect-in-god-mode"}},
        ...
        crafting_speed = {
            ...
            label_tooltip = {"gui.creative-mode_team-crafting-speed-tooltip",
                             {"gui.creative-mode_no-effect-in-cheat-mode"}, {"gui.creative-mode_no-effect-in-god-mode"}},
        ...
        health_bonus = {
            ...
            label_tooltip = {"gui.creative-mode_character-health-bonus-tooltip",
                             {"gui.creative-mode_no-effect-in-god-mode"}},
    ...
    get_button_actual_target_function = function(player, button)
        local force_name = string.match(button.name,
                               creative_mode_defines.match_patterns.gui.team_cheats_target_name_button)
        if force_name then
...
local surface_cheats_menu_gui_data = {
    ...
    cheats_gui_data = {
        ...
        daytime = {
            ...
            label_tooltip = {"gui.creative-mode_daytime-tooltip", {"gui.creative-mode_midday"},
    ...
    get_button_actual_target_function = function(player, button)
        local surface_name = string.match(button.name,
                                 creative_mode_defines.match_patterns.gui.surface_cheats_target_name_button)
...
local build_options_menu_gui_data = {
    ...
    get_button_actual_target_function = function(player, button)
        local player_index = string.match(button.name,
                                 creative_mode_defines.match_patterns.gui.build_options_target_index_button)
        if player_index then
            player_index = tonumber(player_index)
            return game.players[player_index]
        end
...
function gui_menu_cheats.create_cheat_elements_from_data_for_player(player, cheats_container, cheat_gui_data, targets,
...
local function create_enable_and_disable_all_buttons(cheats_container, container_name, enable_all_button_name,
...
local function add_target_button_with_exact_name_in_targets_inner_container_for_player(player, target,
    cheats_menu_gui_data, targets_inner_container, button_name)
    local style
...
-- Returns the created button and whether the target is marked as self.
local function add_target_button_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data,
    targets_inner_container, button_name_prefix)
    return add_target_button_with_exact_name_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data,
               targets_inner_container, button_name_prefix ..
...
local function update_targets_selection_visibility_by_valid_target_count(outer_container, targets_scroll_pane,
...
local function get_all_selected_targets_in_cheats_menu_for_player(player, cheats_menu_gui_data, special_target)
    ...
    local targets_scroll_pane = get_targets_scroll_pane_in_cheats_menu_for_player(player, cheats_menu_gui_data)
    if targets_scroll_pane then
        local targets_inner_container = get_targets_inner_container_in_cheats_menu_for_player(player,
        ...
        if targets_inner_container then
            ...
            if special_target ~= nil then
                ...
                local button_name_prefix = cheats_menu_gui_data.frame.outer_container.targets_scroll_pane
                                               .outer_container.inner_container.target_button.name_prefix
                local button_name = button_name_prefix ..
                                        cheats_menu_gui_data.get_target_button_name_postfix_function(player,
                                            special_target)
                local button = targets_inner_container[button_name]
                if button then
                    local button_style_name = button.style.name
                    if check_style and button_style_name ~=
                        creative_mode_defines.names.gui_styles.cheat_target_selected_button and button_style_name ~=
                        creative_mode_defines.names.gui_styles.cheat_target_self_selected_button then
                        -- Target not selected!
                        return nil
                    end
                else
            ...
            for _, child_name in ipairs(targets_inner_container.children_names) do
                local button = targets_inner_container[child_name]
                local button_style_name = button.style.name
                if (not check_style) or
                    (button_style_name == creative_mode_defines.names.gui_styles.cheat_target_selected_button or
                        button_style_name == creative_mode_defines.names.gui_styles.cheat_target_self_selected_button) then
...
function gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data,
    special_target)
...
local function update_all_cheats_status_in_cheats_menu_for_player_with_known_targets(player, cheats_menu_gui_data,
    targets)
    local cheats_container = get_cheats_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
    if cheats_container then
        for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
    ...
    if outer_container then
        ...
        if targets_scroll_pane then
            local targets_inner_container = get_targets_inner_container_in_cheats_menu_for_player(player,
                                                cheats_menu_gui_data)
            if targets_inner_container then
                update_targets_selection_visibility_by_valid_target_count(outer_container, targets_scroll_pane,
                    targets_inner_container)
            end
        end
    end
                    ...
                    if button then
                        ...
                        if is_add then
                            ...
                            if button.visible == false then
                                ...
                                local button_style_name = button.style.name
                                if button_style_name ==
                                    creative_mode_defines.names.gui_styles.cheat_target_selected_button then
                                    button.style = creative_mode_defines.names.gui_styles.cheat_target_unselected_button
                                elseif button_style_name ==
                                    creative_mode_defines.names.gui_styles.cheat_target_self_selected_button then
                                    button.style = creative_mode_defines.names.gui_styles
                                                       .cheat_target_self_unselected_button
                                else
                                    button.visible = true
                                end
                            ...
                            local need_update_status = button_style_name ==
                                                           creative_mode_defines.names.gui_styles
                                                               .cheat_target_selected_button or button_style_name ==
                                                           creative_mode_defines.names.gui_styles
                                                               .cheat_target_self_selected_button
                        ...
                        if is_add then
                            add_target_button_with_exact_name_in_targets_inner_container_for_player(player, target,
                                cheats_menu_gui_data, targets_inner_container, button_name)
                            update_targets_selection_visibility_for_player(player, cheats_menu_gui_data)
                        end
                    end
            ...
            elseif not destroy_only then
                ...
                if current_structure_data then
                    ...
                    if unverified_target_list then
                        for _, target in pairs(unverified_target_list) do
                            ...
                            if cheats_menu_gui_data.verify_target_function(player, target) then
                                local button, is_self = add_target_button_in_targets_inner_container_for_player(player,
                                                            target, cheats_menu_gui_data, targets_inner_container,
                                                            button_name_prefix)
                                if is_self then
                    ...
                    if single_target then
                        local button, is_self = add_target_button_in_targets_inner_container_for_player(player,
                                                    single_target, cheats_menu_gui_data, targets_inner_container,
                                                    button_name_prefix)
                        if is_self then
                ...
                -- Cheats.
                for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
                    gui_menu_cheats.create_cheat_elements_from_data_for_player(player, cheats_container, cheat_gui_data,
                ...
                if enable_disable_all_container_data then
                    create_enable_and_disable_all_buttons(cheats_container, enable_disable_all_container_data.name,
...
local function update_targets_selection_for_player_in_outer_container(player, cheats_menu_gui_data,
    outer_container_data, outer_container)
    ...
    if current_structure_data then
        ...
        if unverified_target_list then
            for _, target in pairs(unverified_target_list) do
                -- Exclude invalid targets.
                if cheats_menu_gui_data.verify_target_function(player, target) then
                    local button, is_self = add_target_button_in_targets_inner_container_for_player(player, target,
                                                cheats_menu_gui_data, targets_inner_container, button_name_prefix)
                    if cheats_menu_gui_data.check_is_target_button_valid_function(player, target, button) then
                        valid_target_count = valid_target_count + 1
                    end
        ...
        -- Single, verified target.
        if single_target then
            local button, is_self = add_target_button_in_targets_inner_container_for_player(player, single_target,
                                        cheats_menu_gui_data, targets_inner_container, button_name_prefix)
            if cheats_menu_gui_data.check_is_target_button_valid_function(player, single_target, button) then
                valid_target_count = valid_target_count + 1
            end
    ...
    if container then
        ...
        if cheats_menus_container then
            ...
            if frame then
                ...
                local selected_targets = update_targets_selection_for_player_in_outer_container(player,
                                             cheats_menu_gui_data, outer_container_data, outer_container)
                update_all_cheats_status_in_cheats_menu_for_player_with_known_targets(player, cheats_menu_gui_data,
                    selected_targets)
            end
        end
    end
...
function gui_menu_cheats.update_menu_accessibility_according_to_access_right_for_player(player,
            ...
            for _, data in pairs(cheats_menus_gui_data.contents) do
                if updated_access_right_codes[data.access_right_code] then
                    ...
                    if data.get_player_can_access_function(player) then
                        ...
                        local cheats_menu_frame = cheats_menus_container[creative_mode_defines.names.gui
                                                      .cheats_menu_frame]
                        ...
                        if frame then
                            ...
                            -- Cheats.
                            for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
                                gui_menu_cheats.update_cheat_status_from_data(cheats_container, cheat_gui_data,
                                    selected_targets)
                                update_cheat_visibility_from_data_for_player(player, cheats_container, cheat_gui_data)
                            end
                        end
...
function gui_menu_buildoptions.update_menu_accessibility_according_to_access_right_for_player(player,
    updated_access_right_codes)
    local left = mod_gui.get_frame_flow(player)
    local container = left[creative_mode_defines.names.gui.main_menu_container]
    if container then
...
function gui_menu_buildoptions.create_or_destroy_menu_for_player(player)
    ...
    if container then
        ...
        if build_options_menus_container then
            ...
            create_or_destroy_cheats_menu_for_player(player, build_options_menus_gui_data.contents.build_options
                .cheats_menu_gui_data, false)
        end
    end
end
...
function gui_menu_cheats.update_character_cheats_status_for_all_players_as_player_updated_his_status(changed_player)
    for _, player in pairs(game.players) do
        local targets = get_all_selected_targets_in_cheats_menu_for_player(player, personal_cheats_menu_gui_data,
                            changed_player)
        if targets then
            local cheats_container = get_cheats_container_in_cheats_menu_for_player(player,
                                         personal_cheats_menu_gui_data)
            if cheats_container then
...
function gui_menu_cheats.update_daytime_cheats_status_for_all_players_as_surface_updated_its_daytime(changed_surface)
    for _, player in pairs(game.players) do
        local targets = get_all_selected_targets_in_cheats_menu_for_player(player, surface_cheats_menu_gui_data,
                            changed_surface)
        if targets then
...
function gui_menu_cheats.on_player_changed_surface(event)
    ...
    update_targets_selection_and_all_cheats_status_in_cheats_menu_for_player(game.players[event.player_index],
...
function gui_menu_cheats.on_gui_click_in_cheats_menu_toggles(element, element_name, player, cheats_menu_gui_data,
    ...
    for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
            ...
            if element_name == cheat_gui_data.on_button_name then
                ...
                if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                    ...
                    if targets and #targets > 0 then
                        ...
                        cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data,
                            cheat_gui_data.cheat_data, true, true)
                        gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data,
                            cheat_gui_data)
                    end
                else
                    applied_cheat_gui_data = cheat_gui_data
                    ...
                    cheats.apply_cheat_to_targets(player, nil, cheats_menu_gui_data.cheats_data,
                        cheat_gui_data.cheat_data, true, true)
                    gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data,
                        cheat_gui_data)
                end
            ...
            if element_name == cheat_gui_data.off_button_name then
                ...
                if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                    ...
                    if targets and #targets > 0 then
                        ...
                        cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data,
                            cheat_gui_data.cheat_data, false, true)
                        gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data,
                            cheat_gui_data)
                    end
                else
            ...
            if element_name == cheat_gui_data.apply_button_name then
                ...
                if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                    ...
                    if targets and #targets > 0 and current_value ~= nil then
                        ...
                        cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data,
                            cheat_gui_data.cheat_data, current_value, true)
                        gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data,
                            cheat_gui_data)
                    end
                else
            ...
            if element_name == cheat_gui_data.apply_button_name then
                ...
                if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                    ...
                    if targets and #targets > 0 then
                        ...
                        cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data,
                            cheat_gui_data.cheat_data, nil, true)
                    end
                else
                    applied_cheat_gui_data = cheat_gui_data
                    if pre_applied_function then
        ...
        elseif cheat_gui_data.type == gui_menu_cheats.cheat_gui_type.team_target_auto_apply then
            ...
            elseif element.parent and element.parent.name == cheat_gui_data.drop_down_inner_flow_name then
                ...
                local selected_team_name = string.match(element_name,
                                               cheat_gui_data.drop_down_selection_button_name_pattern)
                if selected_team_name then
                    local selected_team = game.forces[selected_team_name]
                    if selected_team then
                        if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                            local targets = get_all_selected_targets_in_cheats_menu_for_player(player,
                                                cheats_menu_gui_data)
                            -- Apply only if there is any target.
                            if targets and #targets > 0 then
                                applied_cheat_gui_data = cheat_gui_data
                                ...
                                cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data,
                                    cheat_gui_data.cheat_data, selected_team, true)
                                gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data,
                                    cheat_gui_data)
                            end
                        else
    ...
    local enable_disable_all_container = cheats_menu_gui_data.frame.outer_container.cheats_scroll_pane.cheats_container
                                             .enable_disable_all_container
    if enable_disable_all_container then
        if element_name == enable_disable_all_container.enable_all_button_name then
            ...
            if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                local targets = get_all_selected_targets_in_cheats_menu_for_player(player, cheats_menu_gui_data)
                if targets and #targets > 0 then
                    cheats.enable_or_disable_all_cheats_to_targets(player, targets, cheats_menu_gui_data.cheats_data,
                        true, true)
        ...
        elseif element_name == enable_disable_all_container.disable_all_button_name then
            ...
            if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
                ...
                cheats.enable_or_disable_all_cheats_to_targets(player, nil, cheats_menu_gui_data.cheats_data, false,
                    true)
                update_all_cheats_status_in_cheats_menu_for_all_players(cheats_menu_gui_data)
            end
            return true
                    ...
                    if cheats_menu_gui_data.check_is_target_button_valid_unknown_target_function(player, button) then
                        ...
                        if deselect_all then
                            ...
                            if style_name == creative_mode_defines.names.gui_styles.cheat_target_unselected_button then
                                button.style = creative_mode_defines.names.gui_styles.cheat_target_selected_button
                            elseif style_name ==
                                creative_mode_defines.names.gui_styles.cheat_target_self_unselected_button then
                                button.style = creative_mode_defines.names.gui_styles.cheat_target_self_selected_button
                            end
                        end
                    end
...
local function on_gui_click_in_cheats_menu_target_buttons(element, element_name, player, button, alt, control, shift,
    cheats_menu_gui_data)
    local inner_container = get_targets_inner_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
                ...
                if shift then
                    ...
                    if storage.last_cheats_menu_gui_actions_by_players and
                        ...
                        for index, children in ipairs(inner_container.children) do
                            ...
                            if style_name == creative_mode_defines.names.gui_styles.cheat_target_selected_button or
                                style_name == creative_mode_defines.names.gui_styles.cheat_target_self_selected_button then
                    ...
                    for index, child in ipairs(inner_container.children) do
                        ...
                        if visible ~= false then
                            ...
                            if index >= min_slot and index <= max_slot then
                                ...
                                elseif style_name ==
                                    creative_mode_defines.names.gui_styles.cheat_target_self_unselected_button then
                                    child.style = creative_mode_defines.names.gui_styles
                                                      .cheat_target_self_selected_button
                                end
                            else
                                -- Deselect.
...
local function on_gui_click_in_cheats_menus_gui_data_contents(element, element_name, player, button, alt, control,
    shift, menus_gui_data)
    ...
    for _, data in pairs(menus_gui_data.contents) do
        ...
        if on_gui_click_in_cheats_menu_target_buttons(element, element_name, player, button, alt, control, shift,
            cheats_menu_gui_data) then
            -- Cheat target.
            return true
        end
    end
...
function gui_menu_cheats.on_gui_click(element, element_name, player, button, alt, control, shift)
    ...
    if on_gui_click_in_cheats_menus_gui_data_contents(element, element_name, player, button, alt, control, shift,
        cheats_menus_gui_data) then
        return true
    end

    -- Detect for the build-options menus.
    if on_gui_click_in_cheats_menus_gui_data_contents(element, element_name, player, button, alt, control, shift,
        build_options_menus_gui_data) then
        return true
    end
