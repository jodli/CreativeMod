...
if not gui_menu_cheats then gui_menu_cheats = {} end
-- Because the build options menu share the same logic as the cheats menu, we put them together in this file.
if not gui_menu_buildoptions then gui_menu_buildoptions = {} end
...
local personal_cheats_menu_gui_data =
{
	...
	cheats_gui_data =
	{
		cheat_mode =
		{
			...
			label_tooltip = {"gui.creative-mode_cheat-mode-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}},
		...
		invincible_player =
		{
			...
			label_tooltip = {"gui.creative-mode_invincible-player-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		keep_last_item =
		{
			...
			label_tooltip = {"gui.creative-mode_keep-last-item-tooltip", {"gui.creative-mode_keep-last-item-tooltip2"}},
		...
		repair_mined_item =
		{
			...
			label_tooltip = {"gui.creative-mode_repair-mined-item-tooltip", {"gui.creative-mode_repair-mined-item-tooltip2"}},
		...
		instant_request =
		{
			...
			label_tooltip = {"gui.creative-mode_instant-request-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		reach_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_reach-distance-tooltip", cheats.default_cheat_values.reach_distance, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		build_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_build-distance-tooltip", cheats.default_cheat_values.reach_distance, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		resource_reach_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_resource-reach-distance-tooltip", cheats.default_cheat_values.reach_distance, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		item_drop_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_item-drop-distance-tooltip", cheats.default_cheat_values.reach_distance, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		item_pickup_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_item-pickup-distance-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		loot_pickup_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_loot-pickup-distance-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		mining_speed =
		{
			...
			label_tooltip = {"gui.creative-mode_mining-speed-tooltip", cheats.default_cheat_values.mining_speed, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		running_speed =
		{
			...
			label_tooltip = {"gui.creative-mode_running-speed-tooltip", cheats.default_cheat_values.running_speed, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		crafting_speed =
		{
			...
			label_tooltip = {"gui.creative-mode_crafting-speed-tooltip", {"gui.creative-mode_no-effect-in-cheat-mode"}, {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		inventory_bonus =
		{
			...
			label_tooltip = {"gui.creative-mode_inventory-bonus-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		health_bonus =
		{
			...
			label_tooltip = {"gui.creative-mode_health-bonus-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}, {"gui.creative-mode_cannot-apply-this-cheat-in-god-mode"}},
		...
		god_mode =
		{
			...
			label_tooltip = {"gui.creative-mode_god-mode-tooltip", {"gui.creative-mode_cannot-apply-this-cheat-before-respawned"}},
	...
	get_button_actual_target_function = function(player, button)
		local player_index = string.match(button.name, creative_mode_defines.match_patterns.gui.personal_cheats_target_index_button)
...
local team_cheats_menu_gui_data =
{
	...
	cheats_gui_data =
	{
		...
		{
			type = gui_menu_cheats.cheat_gui_type.on_off,
			cheat_data = cheats.team_cheats_data.cheats.railgun_recipes,
			container_name = creative_mode_defines.names.gui.railgun_recipes_container,
			label_name = creative_mode_defines.names.gui.railgun_recipes_label,
			label_caption = {"gui.creative-mode_railgun-recipes"},
			label_tooltip = {"gui.creative-mode_railgun-recipes-tooltip"},
			on_button_name = creative_mode_defines.names.gui.railgun_recipes_on_button,
			on_button_caption = creative_mode_defines.names.gui_captions.on,
			off_button_name = creative_mode_defines.names.gui.railgun_recipes_off_button,
			off_button_caption = creative_mode_defines.names.gui_captions.off
		},
		player_port_recipe =
		{
			type = gui_menu_cheats.cheat_gui_type.on_off,
			cheat_data = cheats.team_cheats_data.cheats.player_port_recipe,
			container_name = creative_mode_defines.names.gui.player_port_recipe_container,
			label_name = creative_mode_defines.names.gui.player_port_recipe_label,
			label_caption = {"gui.creative-mode_player-port-recipe"},
			label_tooltip = {"gui.creative-mode_player-port-recipe-tooltip"},
			on_button_name = creative_mode_defines.names.gui.player_port_recipe_on_button,
			on_button_caption = creative_mode_defines.names.gui_captions.on,
			off_button_name = creative_mode_defines.names.gui.player_port_recipe_off_button,
			off_button_caption = creative_mode_defines.names.gui_captions.off
		},
		...
		reach_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_team-reach-distance-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		build_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_team-build-distance-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		resource_reach_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_team-resource-reach-distance-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		item_drop_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_team-item-drop-distance-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		item_pickup_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_team-item-pickup-distance-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		loot_pickup_distance =
		{
			...
			label_tooltip = {"gui.creative-mode_team-loot-pickup-distance-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		running_speed =
		{
			...
			label_tooltip = {"gui.creative-mode_team-running-speed-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		crafting_speed =
		{
			...
			label_tooltip = {"gui.creative-mode_team-crafting-speed-tooltip", {"gui.creative-mode_no-effect-in-cheat-mode"}, {"gui.creative-mode_no-effect-in-god-mode"}},
		...
		health_bonus =
		{
			...
			label_tooltip = {"gui.creative-mode_character-health-bonus-tooltip", {"gui.creative-mode_no-effect-in-god-mode"}},
	...
	get_button_actual_target_function = function(player, button)
		local force_name = string.match(button.name, creative_mode_defines.match_patterns.gui.team_cheats_target_name_button)
		if force_name then
...
local surface_cheats_menu_gui_data =
{
	...
	cheats_gui_data =
	{
		...
		daytime =
		{
			...
			label_tooltip = {"gui.creative-mode_daytime-tooltip", {"gui.creative-mode_midday"}, {"gui.creative-mode_midnight"}},
	...
	get_button_actual_target_function = function(player, button)
		local surface_name = string.match(button.name, creative_mode_defines.match_patterns.gui.surface_cheats_target_name_button)
...
local build_options_menu_gui_data =
{
	...
	get_button_actual_target_function = function(player, button)
		local player_index = string.match(button.name, creative_mode_defines.match_patterns.gui.build_options_target_index_button)
		if player_index then
			player_index = tonumber(player_index)
			return game.players[player_index]
		end
...
function gui_menu_cheats.create_or_destroy_menu_for_player(player)
	...
	if container then
		...
		if cheats_menus_container then
			...
			cheats_menus_container = container.add{type = "flow", name = gui_menu_cheats.get_container_name(), style = creative_mode_defines.names.gui_styles.no_horizontal_spacing_flow, direction = "horizontal"}
			
			-- Cheats frame.
			local cheats_menu_frame = cheats_menus_container.add{type = "frame", name = creative_mode_defines.names.gui.cheats_menu_frame, direction = "vertical", caption = {"gui.creative-mode_cheats"}}
...
local function create_on_off_cheat_elements_from_data(cheats_container, cheat_gui_data, targets)
	-- Container
	local cheat_container = cheats_container.add{type = "table", name = cheat_gui_data.container_name, style = creative_mode_defines.names.gui_styles.cheat_table, column_count = 3}
	-- Label
	cheat_container.add{type = "label", name = cheat_gui_data.label_name, style = creative_mode_defines.names.gui_styles.cheat_name_label, caption = cheat_gui_data.label_caption, tooltip = cheat_gui_data.label_tooltip}
	-- On button
	cheat_container.add{type = "button", name = cheat_gui_data.on_button_name, caption = cheat_gui_data.on_button_caption}
	-- Off button
	cheat_container.add{type = "button", name = cheat_gui_data.off_button_name, caption = cheat_gui_data.off_button_caption}
...
local function create_numeric_apply_cheat_elements_from_data(cheats_container, cheat_gui_data, targets)
	-- Container
	local cheat_container = cheats_container.add{type = "table", name = cheat_gui_data.container_name, style = creative_mode_defines.names.gui_styles.cheat_table, column_count = 4}
	-- Label
	cheat_container.add{type = "label", name = cheat_gui_data.label_name, style = creative_mode_defines.names.gui_styles.cheat_name_label, caption = cheat_gui_data.label_caption, tooltip = cheat_gui_data.label_tooltip}
	-- Textfield
	cheat_container.add{type = "textfield", name = cheat_gui_data.textfield_name, style = creative_mode_defines.names.gui_styles.cheat_numeric_textfield, text = ""}
	-- Separator
	cheat_container.add{type = "flow", name = cheat_gui_data.separator_name, style = creative_mode_defines.names.gui_styles.cheat_textfield_and_button_separate_flow, direction = "horizontal"}
	-- Apply button
	cheat_container.add{type = "button", name = cheat_gui_data.apply_button_name, style = creative_mode_defines.names.gui_styles.cheat_apply_button, caption = cheat_gui_data.apply_button_caption}
...
local function create_one_button_apply_cheat_elements_from_data(cheats_container, cheat_gui_data)
	...
	local cheat_container = cheats_container.add{type = "table", name = cheat_gui_data.container_name, style = creative_mode_defines.names.gui_styles.cheat_table, column_count = 3}
	-- Label
	cheat_container.add{type = "label", name = cheat_gui_data.label_name, style = creative_mode_defines.names.gui_styles.cheat_with_one_button_name_label, caption = cheat_gui_data.label_caption, tooltip = cheat_gui_data.label_tooltip}
	-- Button
	cheat_container.add{type = "button", name = cheat_gui_data.apply_button_name, style = creative_mode_defines.names.gui_styles.cheat_on_off_button_off, caption = cheat_gui_data.apply_button_caption}
end
...
local function create_team_target_auto_apply_cheat_elements_from_data(cheats_container, cheat_gui_data, targets)
	...
	local cheat_container = cheats_container.add{type = "flow", name = cheat_gui_data.container_name, style = creative_mode_defines.names.gui_styles.cheat_flow, direction = "horizontal"}
	-- Label
	cheat_container.add{type = "label", name = cheat_gui_data.label_name, style = creative_mode_defines.names.gui_styles.cheat_name_label, caption = cheat_gui_data.label_caption, tooltip = cheat_gui_data.label_tooltip}
	
	-- Drop down container.
	local drop_down_container = cheat_container.add{type = "flow", name = cheat_gui_data.drop_down_container_name, style = creative_mode_defines.names.gui_styles.no_vertical_spacing_resize_row_flow, direction = "vertical"}
	-- Current selection button.
	drop_down_container.add{type = "button", name = cheat_gui_data.current_selection_button_name, style = creative_mode_defines.names.gui_styles.cheat_value_drop_down_current_target_button, caption = ""}
	-- Drop down scroll pane.
	local drop_down_scroll_pane = drop_down_container.add{type = "scroll-pane", name = cheat_gui_data.drop_down_scroll_pane_name, style = creative_mode_defines.names.gui_styles.cheat_value_drop_down_scroll_pane, horizontal_scroll_policy = "never"}
	-- Drop down inner frame.
	local drop_down_inner_frame = drop_down_scroll_pane.add{type = "frame", name = cheat_gui_data.drop_down_inner_frame_name, style = creative_mode_defines.names.gui_styles.cheat_value_drop_down_container_frame, direction = "vertical"}
	-- Drop down inner flow (vertical spacing doesn't work in frame).
...
function gui_menu_cheats.create_cheat_elements_from_data_for_player(player, cheats_container, cheat_gui_data, targets, check_cheat_visibility_for_player)
	if cheat_gui_data.type == gui_menu_cheats.cheat_gui_type.on_off then
...
local function create_enable_and_disable_all_buttons(cheats_container, container_name, enable_all_button_name, disable_all_button_name)
	-- Container
	local button_container = cheats_container.add{type = "table", name = container_name, style = creative_mode_defines.names.gui_styles.cheat_enable_disable_all_table, column_count = 2}
	-- Enable all button
	button_container.add{type = "button", name = enable_all_button_name, style = creative_mode_defines.names.gui_styles.cheat_enable_disable_all_button, caption = creative_mode_defines.names.gui_captions.enable_all}
	-- Disable all button
	button_container.add{type = "button", name = disable_all_button_name, style = creative_mode_defines.names.gui_styles.cheat_enable_disable_all_button, caption = creative_mode_defines.names.gui_captions.disable_all}
end
...
local function add_target_button_with_exact_name_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data, targets_inner_container, button_name)
	local style
...
-- Returns the created button and whether the target is marked as self.
local function add_target_button_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data, targets_inner_container, button_name_prefix)
	return add_target_button_with_exact_name_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data, targets_inner_container, button_name_prefix .. cheats_menu_gui_data.get_target_button_name_postfix_function(player, target))
end
...
local function update_targets_selection_visibility_by_valid_target_count(outer_container, targets_scroll_pane, targets_inner_container)
	...
	if targets_scroll_pane then
		...
		if targets_inner_container then
			...
			if special_target ~= nil then
				...
				local button_name = button_name_prefix .. cheats_menu_gui_data.get_target_button_name_postfix_function(player, special_target)
				local button = targets_inner_container[button_name]
				if button then
					local button_style_name = button.style.name
					if check_style and button_style_name ~= creative_mode_defines.names.gui_styles.cheat_target_selected_button and button_style_name ~= creative_mode_defines.names.gui_styles.cheat_target_self_selected_button then
						-- Target not selected!
						return nil
					end
				else
			...
			for _, child_name in ipairs(targets_inner_container.children_names) do
				local button = targets_inner_container[child_name]
				local button_style_name = button.style.name
				if (not check_style) or (button_style_name == creative_mode_defines.names.gui_styles.cheat_target_selected_button or button_style_name == creative_mode_defines.names.gui_styles.cheat_target_self_selected_button) then
...
function gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data, special_target)
...
local function update_all_cheats_status_in_cheats_menu_for_player_with_known_targets(player, cheats_menu_gui_data, targets)
	local cheats_container = get_cheats_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
	if cheats_container then
		for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
			gui_menu_cheats.update_cheat_status_from_data(cheats_container, cheat_gui_data, targets)
...
local function update_targets_selection_visibility_for_player(player, cheats_menu_gui_data)
	...
	if outer_container then
		...
		if targets_scroll_pane then
			local targets_inner_container = get_targets_inner_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
			if targets_inner_container then
				update_targets_selection_visibility_by_valid_target_count(outer_container, targets_scroll_pane, targets_inner_container)
			end
		end
	end
end
	...
	if targets_scroll_pane_data then
		...
		for _, player in pairs(game.players) do
			...
			if cheats_menu_gui_data.verify_target_for_insert_function(player, target) then
				local targets_inner_container = get_targets_inner_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
				if targets_inner_container then
					local button_name = button_name_prefix .. cheats_menu_gui_data.get_target_button_name_postfix_function(player, target)
					...
					if button then
						...
						if is_add then
							...
							local button_style_name = button.style.name
							local need_update_status = button_style_name == creative_mode_defines.names.gui_styles.cheat_target_selected_button or button_style_name == creative_mode_defines.names.gui_styles.cheat_target_self_selected_button
						...
						if is_add then
							add_target_button_with_exact_name_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data, targets_inner_container, button_name)
							update_targets_selection_visibility_for_player(player, cheats_menu_gui_data)
						end
					end
				end
	...
	if container then
		...
		if cheats_menus_container then
			...
			elseif not destroy_only then
				-- Not yet opened.
				-- Frame.
				frame = cheats_menus_container.add{type = "frame", name = current_structure_data.name, direction = "vertical", caption = current_structure_data.caption}
				...
				local outer_container = frame.add{type = "flow", name = outer_container_data.name, direction = "horizontal"}
				...
				-- Targets scroll pane.
				if current_structure_data then
					local targets_scroll_pane = outer_container.add{type = "scroll-pane", name = current_structure_data.name, style = creative_mode_defines.names.gui_styles.cheat_scroll_pane}
					
					-- Targets outer container.
					current_structure_data = current_structure_data.outer_container
					local targets_outer_container = targets_scroll_pane.add{type = "frame", name = current_structure_data.name, style = creative_mode_defines.names.gui_styles.cheat_target_selection_container_frame, direction = "vertical"}
                    ...
                    local targets_inner_container = targets_outer_container.add{type = "flow", name = inner_container_data.name, style = creative_mode_defines.names.gui_styles.no_vertical_spacing_resize_row_flow, direction = "vertical"}
					...
					if unverified_target_list then
						for _, target in pairs(unverified_target_list) do
							...
							if cheats_menu_gui_data.verify_target_function(player, target) then
								local button, is_self = add_target_button_in_targets_inner_container_for_player(player, target, cheats_menu_gui_data, targets_inner_container, button_name_prefix)
								if is_self then
					...
					if single_target then
						local button, is_self = add_target_button_in_targets_inner_container_for_player(player, single_target, cheats_menu_gui_data, targets_inner_container, button_name_prefix)
						if is_self then
					...
					targets_scroll_pane.add{type = "button", name = current_structure_data.name, style = creative_mode_defines.names.gui_styles.cheat_select_all_targets_button, caption = {"gui.creative-mode_list-select-all"}, tooltip = {"gui.creative-mode_list-select-all-tooltip"}}
				...
				local cheats_scroll_pane = outer_container.add{type = "scroll-pane", name = current_structure_data.name, style = creative_mode_defines.names.gui_styles.cheat_scroll_pane}
				
				-- Cheats container.
				current_structure_data = current_structure_data.cheats_container
				local cheats_container = cheats_scroll_pane.add{type = "flow", name = current_structure_data.name, direction = "vertical"}
				
				-- Cheats.
				for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
					gui_menu_cheats.create_cheat_elements_from_data_for_player(player, cheats_container, cheat_gui_data, selected_targets, true)
				end
				...
				if current_structure_data.notes then
					for _, note_data in pairs(current_structure_data.notes) do
						cheats_container.add{type = "label", name = note_data.name, style = creative_mode_defines.names.gui_styles.cheat_note_label, caption = note_data.caption}
					end
				end
			end
		end
...
local function update_targets_selection_for_player_in_outer_container(player, cheats_menu_gui_data, outer_container_data, outer_container)
	...
	if current_structure_data then
		...
		for _, child_name in ipairs(targets_inner_container.children_names) do
			local button = targets_inner_container[child_name]
			local button_style_name = button.style.name
			if button_style_name == creative_mode_defines.names.gui_styles.cheat_target_self_selected_button or
				button_style_name == creative_mode_defines.names.gui_styles.cheat_target_selected_button then
	...
	if container then
		...
		if cheats_menus_container then
			...
			if frame then
				...
				local selected_targets = update_targets_selection_for_player_in_outer_container(player, cheats_menu_gui_data, outer_container_data, outer_container)
				update_all_cheats_status_in_cheats_menu_for_player_with_known_targets(player, cheats_menu_gui_data, selected_targets)
			end
		end
	end
	return nil
...
function gui_menu_cheats.update_menu_accessibility_according_to_access_right_for_player(player, updated_access_right_codes)
	local left = mod_gui.get_frame_flow(player)
	local container = left[creative_mode_defines.names.gui.main_menu_container]
	if container then
		-- Cheats container.
...
function gui_menu_buildoptions.update_menu_accessibility_according_to_access_right_for_player(player, updated_access_right_codes)
	local left = mod_gui.get_frame_flow(player)
	local container = left[creative_mode_defines.names.gui.main_menu_container]
	if container then
		-- Cheats container.
...
function gui_menu_buildoptions.create_or_destroy_menu_for_player(player)
	...
	if container then
		...
		if build_options_menus_container then
			...
			build_options_menus_container = container.add{type = "flow", name = gui_menu_buildoptions.get_container_name(), style = creative_mode_defines.names.gui_styles.no_horizontal_spacing_flow, direction = "horizontal"}
			
			-- Create the build options menu by calling the same method for creating cheats menu.
			create_or_destroy_cheats_menu_for_player(player, build_options_menus_gui_data.contents.build_options.cheats_menu_gui_data, false)
		end
	end
end
...
function gui_menu_cheats.update_character_cheats_status_for_all_players_as_player_updated_his_status(changed_player)
	for _, player in pairs(game.players) do
		local targets = get_all_selected_targets_in_cheats_menu_for_player(player, personal_cheats_menu_gui_data, changed_player)
		if targets then
...
function gui_menu_cheats.update_daytime_cheats_status_for_all_players_as_surface_updated_its_daytime(changed_surface)
	for _, player in pairs(game.players) do
		local targets = get_all_selected_targets_in_cheats_menu_for_player(player, surface_cheats_menu_gui_data, changed_surface)
		if targets then
...
function gui_menu_cheats.on_player_changed_surface(event)
	...
	update_targets_selection_and_all_cheats_status_in_cheats_menu_for_player(game.players[event.player_index], surface_cheats_menu_gui_data)
end
...
function gui_menu_cheats.on_gui_click_in_cheats_menu_toggles(element, element_name, player, cheats_menu_gui_data, pre_applied_function)
	for _, cheat_gui_data in pairs(cheats_menu_gui_data.cheats_gui_data) do
			...
			if element_name == cheat_gui_data.on_button_name then
				...
				if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
					...
					if targets and #targets > 0 then
						...
						applied_value = true
						if pre_applied_function then pre_applied_function(targets, applied_cheat_gui_data, applied_value) end
						cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, true, true)
					...
					applied_cheat_gui_data = cheat_gui_data
					applied_value = true
					if pre_applied_function then pre_applied_function(nil, applied_cheat_gui_data, applied_value) end
					cheats.apply_cheat_to_targets(player, nil, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, true, true)
					gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
				end
			...
			if element_name == cheat_gui_data.off_button_name then
				...
				if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
					...
					if targets and #targets > 0 then
						...
						applied_value = false
						if pre_applied_function then pre_applied_function(targets, applied_cheat_gui_data, applied_value) end
						cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, false, true)
						gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
					end
				else
					applied_cheat_gui_data = cheat_gui_data
					applied_value = false
					if pre_applied_function then pre_applied_function(nil, applied_cheat_gui_data, applied_value) end
					cheats.apply_cheat_to_targets(player, nil, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, false, true)
					gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
				end
				return true, applied_cheat_gui_data, applied_value
			end
			...
			if element_name == cheat_gui_data.apply_button_name then
				...
				if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
					...
					if targets and #targets > 0 and current_value ~= nil then
						...
						if pre_applied_function then pre_applied_function(targets, applied_cheat_gui_data, applied_value) end
						cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, current_value, true)
						gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
					end
				else
					applied_cheat_gui_data = cheat_gui_data
					applied_value = current_value
					if pre_applied_function then pre_applied_function(nil, applied_cheat_gui_data, applied_value) end
					cheats.apply_cheat_to_targets(player, nil, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, current_value, true)
					gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
				end
				return true, applied_cheat_gui_data, applied_value
			end
			...
			if element_name == cheat_gui_data.apply_button_name then
				...
				if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
					...
					if targets and #targets > 0 then
						applied_cheat_gui_data = cheat_gui_data
						if pre_applied_function then pre_applied_function(targets, applied_cheat_gui_data, applied_value) end
						cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, nil, true)
					end
				else
					applied_cheat_gui_data = cheat_gui_data
					if pre_applied_function then pre_applied_function(nil, applied_cheat_gui_data, applied_value) end
					cheats.apply_cheat_to_targets(player, nil, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, nil, true)
				end
					...
					if selected_team then
						if get_cheats_menu_has_targets_selection(cheats_menu_gui_data) then
							...
							if targets and #targets > 0 then
								...
								if pre_applied_function then pre_applied_function(targets, applied_cheat_gui_data, applied_value) end
								cheats.apply_cheat_to_targets(player, targets, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, selected_team, true)
								gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
							end
						else
							applied_cheat_gui_data = cheat_gui_data
							applied_value = selected_team_name
							if pre_applied_function then pre_applied_function(nil, applied_cheat_gui_data, applied_value) end
							cheats.apply_cheat_to_targets(player, nil, cheats_menu_gui_data.cheats_data, cheat_gui_data.cheat_data, selected_team, true)
							gui_menu_cheats.update_cheat_status_in_cheats_menu_for_all_players(cheats_menu_gui_data, cheat_gui_data)
						end
						-- Hide the selection.
						local cheats_container = get_cheats_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
	...
	local enable_disable_all_container = cheats_menu_gui_data.frame.outer_container.cheats_scroll_pane.cheats_container.enable_disable_all_container
			...
			if inner_container then
				...
				for _, child_name in ipairs(inner_container.children_names) do
					...
					if cheats_menu_gui_data.check_is_target_button_valid_unknown_target_function(player, button) then
						local style_name = button.style.name
						if style_name == creative_mode_defines.names.gui_styles.cheat_target_unselected_button or
							style_name == creative_mode_defines.names.gui_styles.cheat_target_self_unselected_button then
							deselect_all = false
							break
						end
					end
...
local function on_gui_click_in_cheats_menu_target_buttons(element, element_name, player, button, alt, control, shift, cheats_menu_gui_data)
	local inner_container = get_targets_inner_container_in_cheats_menu_for_player(player, cheats_menu_gui_data)
		...
		if cheats_menu_gui_data.get_button_actual_target_function then
			...
			if target then
				...
				if control then
					...
					global.last_cheats_menu_gui_actions_by_players[player.index] = {non_shift = {slot = slot}}
					return true
				end
				...
				if shift then
					...
					if global.last_cheats_menu_gui_actions_by_players and global.last_cheats_menu_gui_actions_by_players[player.index] and global.last_cheats_menu_gui_actions_by_players[player.index].non_shift then
						...
						for index, children in ipairs(inner_container.children) do
							...
							if style_name == creative_mode_defines.names.gui_styles.cheat_target_selected_button or style_name == creative_mode_defines.names.gui_styles.cheat_target_self_selected_button then
								non_shift_slot = index
								break
							end
						end
						global.last_cheats_menu_gui_actions_by_players = global.last_cheats_menu_gui_actions_by_players or {}
						global.last_cheats_menu_gui_actions_by_players[player.index] = {non_shift = {slot = non_shift_slot}}
					end
...
local function on_gui_click_in_cheats_menus_gui_data_contents(element, element_name, player, button, alt, control, shift, menus_gui_data)
	for _, data in pairs(menus_gui_data.contents) do
		if gui_menu_cheats.on_gui_click_in_cheats_menu_toggles(element, element_name, player, data.cheats_menu_gui_data) then
			-- Cheat toggle.
			return true
		end
	end
	...
	for _, data in pairs(menus_gui_data.contents) do
		...
		if on_gui_click_in_cheats_menu_target_buttons(element, element_name, player, button, alt, control, shift, cheats_menu_gui_data) then
			-- Cheat target.
			return true
		end
	end
...
function gui_menu_cheats.on_gui_click(element, element_name, player, button, alt, control, shift)
	...
	if on_gui_click_in_cheats_menus_gui_data_contents(element, element_name, player, button, alt, control, shift, cheats_menus_gui_data) then
		return true
	end
	
	-- Detect for the build-options menus.
	if on_gui_click_in_cheats_menus_gui_data_contents(element, element_name, player, button, alt, control, shift, build_options_menus_gui_data) then
		return true
	end
