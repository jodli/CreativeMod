...
if not global_util then global_util = {} end
...
function global_util.initialize_or_update_global()
	...
	if not global.creative_mode.creative_chest_data_groups then global.creative_mode.creative_chest_data_groups = {} end
	if not global.creative_mode.creative_chest_next_group then global.creative_mode.creative_chest_next_group = 1 end -- The group number for the next placed creative chest. (Number of items in each group <= Chest inventory size)
	if not global.creative_mode.creative_provider_chest_data_groups then global.creative_mode.creative_provider_chest_data_groups = {} end
	if not global.creative_mode.creative_provider_chest_next_group then global.creative_mode.creative_provider_chest_next_group = 1 end
	if not global.creative_mode.autofill_requester_chest then global.creative_mode.autofill_requester_chest = {} end
	if not global.creative_mode.autofill_requester_chest_next_update_index then global.creative_mode.autofill_requester_chest_next_update_index = 1 end
	if not global.creative_mode.duplicating_chest_data then global.creative_mode.duplicating_chest_data = {} end
	if not global.creative_mode.duplicating_chest_next_update_index then global.creative_mode.duplicating_chest_next_update_index = 1 end
	if not global.creative_mode.duplicating_provider_chest_data then global.creative_mode.duplicating_provider_chest_data = {} end
	if not global.creative_mode.duplicating_provider_chest_next_update_index then global.creative_mode.duplicating_provider_chest_next_update_index = 1 end
	if not global.creative_mode.void_requester_chest then global.creative_mode.void_requester_chest = {} end
	if not global.creative_mode.void_requester_chest_next_update_index then global.creative_mode.void_requester_chest_next_update_index = 1 end
	if not global.creative_mode.void_storage_chest then global.creative_mode.void_storage_chest = {} end
	if not global.creative_mode.void_storage_chest_next_update_index then global.creative_mode.void_storage_chest_next_update_index = 1 end
	if not global.creative_mode.creative_cargo_wagon_data_groups then global.creative_mode.creative_cargo_wagon_data_groups = {} end
	if not global.creative_mode.creative_cargo_wagon_next_group then global.creative_mode.creative_cargo_wagon_next_group = 1 end
	if not global.creative_mode.duplicating_cargo_wagon_data then global.creative_mode.duplicating_cargo_wagon_data = {} end
	if not global.creative_mode.duplicating_cargo_wagon_next_update_index then global.creative_mode.duplicating_cargo_wagon_next_update_index = 1 end
	if not global.creative_mode.void_cargo_wagon then global.creative_mode.void_cargo_wagon = {} end
	if not global.creative_mode.void_cargo_wagon_next_update_index then global.creative_mode.void_cargo_wagon_next_update_index = 1 end
	if not global.creative_mode.super_roboport then global.creative_mode.super_roboport = {} end
	if not global.creative_mode.fluid_source then global.creative_mode.fluid_source = {} end
	if not global.creative_mode.fluid_void then global.creative_mode.fluid_void = {} end
	if not global.creative_mode.super_boiler then global.creative_mode.super_boiler = {} end
	if not global.creative_mode.super_cooler then global.creative_mode.super_cooler = {} end
	if not global.creative_mode.configurable_super_boiler_data then global.creative_mode.configurable_super_boiler_data = {} end
	if not global.creative_mode.heat_source then global.creative_mode.heat_source = {} end
	if not global.creative_mode.heat_void then global.creative_mode.heat_void = {} end
	if not global.creative_mode.item_source_data then global.creative_mode.item_source_data = {} end
	if not global.creative_mode.duplicator_data then global.creative_mode.duplicator_data = {} end
	if not global.creative_mode.item_void_data then global.creative_mode.item_void_data = {} end
	if not global.creative_mode.random_item_source_data then global.creative_mode.random_item_source_data = {} end
	if not global.creative_mode.creative_lab then global.creative_mode.creative_lab = {} end
	if not global.creative_mode.creative_lab_next_update_index then global.creative_mode.creative_lab_next_update_index = 1 end
	if not global.creative_mode.energy_source then global.creative_mode.energy_source = {} end
	if not global.creative_mode.passive_energy_source then global.creative_mode.passive_energy_source = {} end
	if not global.creative_mode.energy_void then global.creative_mode.energy_void = {} end
	if not global.creative_mode.passive_energy_void then global.creative_mode.passive_energy_void = {} end
	if not global.creative_mode.super_radar then global.creative_mode.super_radar = {} end
	if not global.creative_mode.super_beacon then global.creative_mode.super_beacon = {} end
	
	-- Table for storing the equipments that need to be refilled with energy.
	if not global.energy_refill_equipments then global.energy_refill_equipments = {} end
	
	-- Table for storing which entity each player has opened.
	if not global.creative_mode.player_opened_entities then global.creative_mode.player_opened_entities = {} end
	-- Table for storing whether the entity GUI is opened.
	if not global.creative_mode.player_opened_entity_gui then global.creative_mode.player_opened_entity_gui = {} end
	...
	if not global.creative_mode.permanently_disabled then global.creative_mode.permanently_disabled = false end
	
	-- Player rights.existence determinator
	if not global.creative_mode.player_rights then global.creative_mode.player_rights = {} end
	...
	if not global.creative_mode.personal_cheats then global.creative_mode.personal_cheats = {} end
	-- Cheat mode.
	if not global.creative_mode.personal_cheats.cheat_mode then global.creative_mode.personal_cheats.cheat_mode = {} end
	-- Invincible player.
	if not global.creative_mode.personal_cheats.invincible_player then global.creative_mode.personal_cheats.invincible_player = {} end
	-- Keep last item.
	if not global.creative_mode.personal_cheats.keep_last_item then global.creative_mode.personal_cheats.keep_last_item = {} end
	-- Repair mined item.
	if not global.creative_mode.personal_cheats.repair_mined_item then global.creative_mode.personal_cheats.repair_mined_item = {} end
	...
	if not global.creative_mode.personal_cheats.has_restored_cursor_stack then global.creative_mode.personal_cheats.has_restored_cursor_stack = {} end
	-- Instant request.
	if not global.creative_mode.personal_cheats.instant_request then global.creative_mode.personal_cheats.instant_request = {} end
	...
	if not global.creative_mode.personal_cheats.instant_request_next_player_slot_index then global.creative_mode.personal_cheats.instant_request_next_player_slot_index = 1 end
	-- Instant trash.
	if not global.creative_mode.personal_cheats.instant_trash then global.creative_mode.personal_cheats.instant_trash = {} end
	...
	-- Instant blueprint.
	if not global.creative_mode.personal_cheats.instant_blueprint then global.creative_mode.personal_cheats.instant_blueprint = {} end
	-- Instant deconstruction.
	if not global.creative_mode.personal_cheats.instant_deconstruction then global.creative_mode.personal_cheats.instant_deconstruction = {} end
	-- Reach distance.
	if not global.creative_mode.personal_cheats.reach_distance then global.creative_mode.personal_cheats.reach_distance = {} end
	-- Build distance.
	if not global.creative_mode.personal_cheats.build_distance then	global.creative_mode.personal_cheats.build_distance = {} end
	-- Resource reach distance.
	if not global.creative_mode.personal_cheats.resource_reach_distance then global.creative_mode.personal_cheats.resource_reach_distance = {} end
	-- Item drop distance.
	if not global.creative_mode.personal_cheats.item_drop_distance then global.creative_mode.personal_cheats.item_drop_distance = {} end
	-- Item pickup distance.
	if not global.creative_mode.personal_cheats.item_pickup_distance then global.creative_mode.personal_cheats.item_pickup_distance = {} end
	-- Loot pickup distance.
	if not global.creative_mode.personal_cheats.loot_pickup_distance then global.creative_mode.personal_cheats.loot_pickup_distance = {} end
	-- Mining speed.
	if not global.creative_mode.personal_cheats.mining_speed then global.creative_mode.personal_cheats.mining_speed = {} end
	-- Running speed.
	if not global.creative_mode.personal_cheats.running_speed then global.creative_mode.personal_cheats.running_speed = {} end
	-- Crafting speed.
	if not global.creative_mode.personal_cheats.crafting_speed then global.creative_mode.personal_cheats.crafting_speed = {} end
	-- Inventory bonus.
	if not global.creative_mode.personal_cheats.inventory_bonus then global.creative_mode.personal_cheats.inventory_bonus = {} end
	-- Quickbar bonus.
	if not global.creative_mode.personal_cheats.quickbar_bonus then global.creative_mode.personal_cheats.quickbar_bonus = {} end
	-- Health bonus.
	if not global.creative_mode.personal_cheats.health_bonus then global.creative_mode.personal_cheats.health_bonus = {} end
	-- God mode : list of characters that were previously characters of players before god mode was enabled.
	if not global.creative_mode.personal_cheats.god_mode_character then global.creative_mode.personal_cheats.god_mode_character = {} end
	
	-- Table of team cheats for each team.
	if not global.creative_mode.team_cheats then global.creative_mode.team_cheats = {} end
	-- Instant research.
	if not global.creative_mode.team_cheats.instant_research then global.creative_mode.team_cheats.instant_research = {} end
	
	-- Table of surface cheats for each surface.
	if not global.creative_mode.surface_cheats then global.creative_mode.surface_cheats = {} end
	-- Don't generate enemy.
	if not global.creative_mode.surface_cheats.dont_generate_enemy then global.creative_mode.surface_cheats.dont_generate_enemy = {} end
	
	-- Table of build options for each player.
	if not global.creative_mode.build_options then global.creative_mode.build_options = {} end
	-- Active.
	if not global.creative_mode.build_options.active then global.creative_mode.build_options.active = {} end
	-- Destructible.
	if not global.creative_mode.build_options.destructible then global.creative_mode.build_options.destructible = {} end
	-- Minable.
	if not global.creative_mode.build_options.minable then global.creative_mode.build_options.minable = {} end
	-- Rotatable.
	if not global.creative_mode.build_options.rotatable then global.creative_mode.build_options.rotatable = {} end
	-- Operable.
	if not global.creative_mode.build_options.operable then global.creative_mode.build_options.operable = {} end
	-- Full health.
	if not global.creative_mode.build_options.full_health then global.creative_mode.build_options.full_health = {} end
	-- Team (force name).
	if not global.creative_mode.build_options.team then global.creative_mode.build_options.team = {} end
	
	-- Table of magic wand settings for each player.
	if not global.creative_mode.magic_wand_settings then global.creative_mode.magic_wand_settings = {} end
	-- Creator.
	if not global.creative_mode.magic_wand_settings.creator then global.creative_mode.magic_wand_settings.creator = {} end
	-- Healer.
	if not global.creative_mode.magic_wand_settings.healer then global.creative_mode.magic_wand_settings.healer = {} end
	-- Modifier.
	if not global.creative_mode.magic_wand_settings.modifier then global.creative_mode.magic_wand_settings.modifier = {} end
	-- Modifier - selected entities.
	if not global.creative_mode.modifier_magic_wand_selection then global.creative_mode.modifier_magic_wand_selection = {} end
	-- Modifier - quick actions.
	if not global.creative_mode.modifier_magic_wand_quick_actions then global.creative_mode.modifier_magic_wand_quick_actions = {} end
	
	
	-- Unused. Previously it is used for global instant blueprint and instant deconstruction (before v0.2.0)
	if global.creative_mode.cheats then global.creative_mode.cheats = nil end
	...
	if not global.creative_mode.selected_events then global.creative_mode.selected_events = {} end
	-- Table of Booleans, for whether the selected events should be printed in each player's console.
	if not global.creative_mode.print_events then global.creative_mode.print_events = {} end
	-- Table of Booleans, for whether the parameters of the events should also be printed.
	if not global.creative_mode.also_print_event_params then global.creative_mode.also_print_event_params = {} end
	-- Table of Booleans, for whether the selected events should be written in each player's file system as txt files.
	if not global.creative_mode.write_events then global.creative_mode.write_events = {} end
	-- Table of Booleans, for whether the parameters of the events should also be written.
	if not global.creative_mode.also_write_event_params then global.creative_mode.also_write_event_params = {} end
	-- Table of Booleans, for whether the selected events should be logged in each player's file system as log files.
	if not global.creative_mode.log_events then global.creative_mode.log_events = {} end
	-- Table of Booleans, for whether the parameters of the events should also be logged.
	if not global.creative_mode.also_log_event_params then global.creative_mode.also_log_event_params = {} end
...
function global_util.renew_item_lists()
	...
	for _, item in pairs(game.item_prototypes) do
		if item.has_flag("hidden") then
			...
			elseif not util.array_contains(creative_mode_defines.values.creative_provider_chest_additional_content_names, item.name) then
				-- Not our hidden item.
...
{	
	[creative_mode_defines.names.entities.creative_chest] = function(entity)
		...
		table.insert(global.creative_mode.creative_chest_data_groups[global.creative_mode.creative_chest_next_place_group],
		{
	...
	[creative_mode_defines.names.entities.creative_provider_chest] = function(entity)
		...
		if not global.creative_mode.creative_provider_chest_data_groups[global.creative_mode.creative_provider_chest_next_place_group] then
			global.creative_mode.creative_provider_chest_data_groups[global.creative_mode.creative_provider_chest_next_place_group] = {}
		end
		table.insert(global.creative_mode.creative_provider_chest_data_groups[global.creative_mode.creative_provider_chest_next_place_group],
		{
			entity = entity,																	-- The creative-chest entity.
			filtered_slots = {},																-- The slot indexes that are filtered out in this chest.
			inventory_display_mode = creative_chest_util.inventory_display_modes.original_mode,	-- The inventory display mode.
		...
		-- Increase the group number for the next chest.
		if global.creative_mode.creative_provider_chest_next_place_group < global.creative_mode.creative_provider_chest_num_in_cycle then
			global.creative_mode.creative_provider_chest_next_place_group = global.creative_mode.creative_provider_chest_next_place_group + 1
		else
	...
	[creative_mode_defines.names.entities.duplicating_chest] = function(entity)
		table.insert(global.creative_mode.duplicating_chest_data,
		{
			entity = entity,
	...
	[creative_mode_defines.names.entities.duplicating_provider_chest] = function(entity)
		table.insert(global.creative_mode.duplicating_provider_chest_data,
		{
			entity = entity,
			lock_item = false,		-- Whether the item to be duplicated is locked.
			locked_item_name = nil	-- Name of the item to be duplicated even if the first slot is empty.
	...
	[creative_mode_defines.names.entities.creative_cargo_wagon] = function(entity)
		...
		if not global.creative_mode.creative_cargo_wagon_data_groups[global.creative_mode.creative_cargo_wagon_next_place_group] then
			global.creative_mode.creative_cargo_wagon_data_groups[global.creative_mode.creative_cargo_wagon_next_place_group] = {}
		end
		table.insert(global.creative_mode.creative_cargo_wagon_data_groups[global.creative_mode.creative_cargo_wagon_next_place_group],
		{
		...
		if global.creative_mode.creative_cargo_wagon_next_place_group < global.creative_mode.creative_cargo_wagon_num_in_cycle then
			global.creative_mode.creative_cargo_wagon_next_place_group = global.creative_mode.creative_cargo_wagon_next_place_group + 1
		else
	...
	[creative_mode_defines.names.entities.duplicating_cargo_wagon] = function(entity)
		table.insert(global.creative_mode.duplicating_cargo_wagon_data,
		{
			entity = entity,
			lock_item = false,		-- Whether the item to be duplicated is locked.
			locked_item_name = nil	-- Name of the item to be duplicated even if the first slot is empty.
	...
	[creative_mode_defines.names.entities.configurable_super_boiler] = function(entity)
		table.insert(global.creative_mode.configurable_super_boiler_data,
		{
			entity = entity,
			temperature = 100.0
		})
	...
	[creative_mode_defines.names.entities.duplicator] = function(entity)
		table.insert(global.creative_mode.duplicator_data,
		{
	...
	[creative_mode_defines.names.entities.item_void] = function(entity)
		table.insert(global.creative_mode.item_void_data,
		{
	...
	[creative_mode_defines.names.entities.random_item_source] = function(entity)
		...
		table.insert(global.creative_mode.random_item_source_data,
		{
