    ...
    if global.creative_mode.creative_provider_chest_groups then
        for index, groups in ipairs(global.creative_mode.creative_provider_chest_groups) do
            ...
            for index2, chest in ipairs(groups) do
                table.insert(global.creative_mode.creative_provider_chest_data_groups[index], {
                    entity = chest,
                    filtered_slots = {}
                })
            end
...
local register_entity_look_up_functions = {
    [creative_mode_defines.names.entities.creative_chest] = function(entity)
        ...
        if global.creative_mode.creative_chest_next_place_group <
            ...
            global.creative_mode.creative_chest_next_place_group =
    ...
    [creative_mode_defines.names.entities.creative_cargo_wagon] = function(entity)
        ...
        if not global.creative_mode.creative_cargo_wagon_data_groups[global.creative_mode
            .creative_cargo_wagon_next_place_group] then
            global.creative_mode.creative_cargo_wagon_data_groups[global.creative_mode
                .creative_cargo_wagon_next_place_group] = {}
        end
        table.insert(global.creative_mode.creative_cargo_wagon_data_groups[global.creative_mode
                         .creative_cargo_wagon_next_place_group], {
        ...
        if global.creative_mode.creative_cargo_wagon_next_place_group <
            global.creative_mode.creative_cargo_wagon_num_in_cycle then
