...
if not creative_provider_chest then creative_provider_chest = {} end
...
function creative_provider_chest.tick()
	...
	global.creative_mode.creative_provider_chest_next_update_group, global.creative_mode.creative_provider_chest_next_update_group_subindex = creative_chest_util.refill_chests(
