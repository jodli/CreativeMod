...
function rights.can_player_access_build_options_menu(player)
  ...
  if
    storage.creative_mode.player_rights.access_build_options == rights.access_build_options_level.no_team_options
    or storage.creative_mode.player_rights.access_build_options == rights.access_build_options_level.free
  then
    return true
  end
...
function rights.can_player_access_magic_wand_menu(player)
  return rights.can_player_use_creator_magic_wand(player)
    or rights.can_player_use_healer_magic_wand(player)
    or rights.can_player_use_modifier_magic_wand(player)
end
...
function rights.can_player_access_creative_mode_menu(player)
  ...
  return rights.can_player_access_cheats_menu(player)
    or rights.can_player_access_build_options_menu(player)
    or rights.can_player_access_magic_wand_menu(player)
    or rights.can_player_access_modding_menu(player)
end
