...
local function show_yes_no_popup(player, frame_name, frame_caption, btn_container_name, yes_btn_name, no_btn_name, label_1_data, label_2_data)
	local center = player.gui.center
	local popup = center.add{type = "frame", name = frame_name, direction = "vertical", caption = frame_caption}
	
	if label_1_data then
		local label = popup.add{type = "label", name = creative_mode_defines.names.gui.popup_label, caption = label_1_data.caption}
		label.style.font_color = label_1_data.font_color
	end
	
	if label_2_data then
		local label = popup.add{type = "label", name = creative_mode_defines.names.gui.popup_label2, caption = label_2_data.caption}
	...
	if yes_btn_name then
		buttons_container.add{type = "button", name = yes_btn_name, style = "dialog_button", caption = creative_mode_defines.names.gui_captions.yes}
	end
	if no_btn_name then
		buttons_container.add{type = "button", name = no_btn_name, style = "dialog_button", caption = creative_mode_defines.names.gui_captions.no}
	end
end
...
function gui.show_main_popup(player, main_popup_content_type)
	if main_popup_content_type == gui.main_popup_content_type.enable_creative_mode then
		...
		local center = player.gui.center
		local popup = center.add{type = "frame", name = creative_mode_defines.names.gui.popup, direction = "vertical", caption = {"gui.creative-mode_ask-enable-creative-mode"}}
		local buttons_container = popup.add{type = "table", name = creative_mode_defines.names.gui.popup_buttons_container, column_count = 2}
		
		local button_style = creative_mode_defines.names.gui_styles.long_dialog_button
		-- Yes.
		buttons_container.add{type = "button", name = creative_mode_defines.names.gui.enable_creative_mode_yes, style = button_style, caption = creative_mode_defines.names.gui_captions.yes}
		-- Yes with cheats.
		buttons_container.add{type = "button", name = creative_mode_defines.names.gui.enable_creative_mode_yes_with_cheats, style = button_style, caption = {"gui.creative-mode_enable-creative-mode-with-cheats-button"}, tooltip = {"gui.creative-mode_enable-creative-mode-with-cheats-button-tooltip"}}
		-- No.
		buttons_container.add{type = "button", name = creative_mode_defines.names.gui.enable_creative_mode_no, style = button_style, caption = {"gui.creative-mode_dont-enable-creative-mode-button"}, tooltip = {"gui.creative-mode_dont-enable-creative-mode-button-tooltip"}}
		-- No permanently.
		buttons_container.add{type = "button", name = creative_mode_defines.names.gui.enable_creative_mode_no_permanently, style = button_style, caption = {"gui.creative-mode_dont-enable-creative-mode-permanently-button"}, tooltip = {"gui.creative-mode_dont-enable-creative-mode-permanently-button-tooltip"}}
		
	elseif main_popup_content_type == gui.main_popup_content_type.disable_creative_mode then
		-- Disable Creative Mode?
		show_yes_no_popup(player,
