		...
		if point ~= nil and point.enabled and point.filters ~= nil then
			...
			if item_count_diff > 0 then
				...
				player.insert({
					...
					quality = requested_item_stack.quality,
				})
			end
		end
	end
...
local function is_player_valid_for_instant_trash(player)
	return storage.creative_mode.personal_cheats.instant_trash[player.index]
		and player.valid
		and player.connected
		and player.character
end
...
function cheats.tick()
	-- Instant request.
	storage.creative_mode.personal_cheats.instant_request_next_player_index, storage.creative_mode.personal_cheats.instant_request_next_player_slot_index =
		apply_slot_cheat_to_players(
			storage.creative_mode.personal_cheats.instant_request_next_player_index,
			storage.creative_mode.personal_cheats.instant_request_next_player_slot_index,
	...
	-- Instant trash.
	storage.creative_mode.personal_cheats.instant_trash_next_player_index, _ = apply_slot_cheat_to_players(
		storage.creative_mode.personal_cheats.instant_trash_next_player_index,
		0,
