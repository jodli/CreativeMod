...
gui_menu_magicwand.modification_popup_cheats_gui_data = {
    ...
    cheats_gui_data = {
        ...
        team = {
            ...
            drop_down_container_name = creative_mode_defines.names.gui
                .magic_wand_modifier_team_targets_drop_down_container,
            ...
            drop_down_selection_button_name_prefx = creative_mode_defines.names.gui
                .magic_wand_modifier_team_target_name_button_prefix,
            drop_down_selection_button_name_pattern = creative_mode_defines.match_patterns.gui
                .magic_wand_modifier_team_target_name_button,
            action_code = "team",
...
local function create_forces_table(player, forces_table_container, forces_table_name, force_checkbox_name_prefix,
    get_force_checkbox_state_function, select_all_button_name)
    -- Force table.
...
local function create_tile_or_resource_selection_for_creator(player, container, get_selected_tile_prototype_function,
    tiles_table_name, tile_name_button_prefix, get_selected_resource_prototype_function, resources_table_name,
    resource_name_button_prefix, get_resource_amount_function, resource_amount_slider_container_name,
    resource_amount_slider_label_name, resource_amount_slider_space_name, resource_amount_slider_button_name_prefix,
    resource_amount_slider_space_2_name, resource_amount_slider_textfield_name)
...
local function create_common_elements_for_modifier(player, container, get_ignore_player_characters_function,
    ignore_player_characters_checkbox_name, get_ignore_healthless_entities_function,
    ignore_healthless_entities_checkbox_name, get_ignore_indestructible_entities_function,
    ignore_indestructible_entities_checkbox_name, forces_table_label_name, forces_table_name,
    force_checkbox_name_prefix, get_force_checkbox_state_function, select_all_button_name)
    ...
    -- Force table.
    create_forces_table(player, container, forces_table_name, force_checkbox_name_prefix,
        get_force_checkbox_state_function, select_all_button_name)
end
...
local function clear_all_elements_for_recorded_actions_of_modifier(actions_container, container)
    ...
    local remove_all_button = container[creative_mode_defines.names.gui
                                  .magic_wand_modifier_remove_all_quick_actions_button]
...
gui_menu_magicwand.magic_wand_menus_gui_data = {
    creator = {
        ...
        contents = {
            ...
            alt_select_mode_container_name = creative_mode_defines.names.gui
                .magic_wand_creator_alt_select_mode_container,
            ...
            create_select_mode_gui_function = function(player, container)
                ...
                create_tile_or_resource_selection_for_creator(player, container,
                    magic_wand_creator.get_selected_tile_prototype, creative_mode_defines.names.gui
                        .magic_wand_creator_tiles_table, creative_mode_defines.names.gui
                        .magic_wand_creator_tile_name_button_prefix, magic_wand_creator.get_selected_resource_prototype,
                    creative_mode_defines.names.gui.magic_wand_creator_resources_table, creative_mode_defines.names.gui
                        .magic_wand_creator_resource_name_button_prefix, magic_wand_creator.get_resource_amount,
                ...
                use_pattern_container.add {
                    ...
                    items = {{"gui.creative-mode_no-pattern"}, {"gui.creative-mode_horizontal-stripe-pattern"},
                             {"gui.creative-mode_vertical-stripe-pattern"}, {"gui.creative-mode_checker-pattern"},
                ...
                -- UI.
                create_tile_or_resource_selection_for_creator(player, tile_or_resource_2_container,
                    magic_wand_creator.get_selected_tile_prototype_2, creative_mode_defines.names.gui
                        .magic_wand_creator_tiles_table_2, creative_mode_defines.names.gui
                        .magic_wand_creator_tile_name_button_2_prefix,
                    magic_wand_creator.get_selected_resource_prototype_2, creative_mode_defines.names.gui
                        .magic_wand_creator_resources_table_2, creative_mode_defines.names.gui
                        .magic_wand_creator_resource_name_button_2_prefix, magic_wand_creator.get_resource_amount_2,
            ...
            create_alt_select_mode_gui_function = function(player, container)
                ...
                local dont_kill_players_by_removing_tiles = magic_wand_creator.get_dont_kill_players_by_removing_tiles(
                                                                player)
                -- Checkbox.
                container.add {
                    type = "checkbox",
                ...
                label.style.top_padding = 8
                -- Force table.
                create_forces_table(player, container,
    ...
    healer = {
        ...
        contents = {
            ...
            create_alt_select_mode_gui_function = function(player, container)
                ...
                -- Checkbox.
                local alt_mode_dont_affect_player_characters_checkbox =
                    container.add {
                        type = "checkbox",
                ...
                -- Force table.
                create_forces_table(player, container,
                    creative_mode_defines.names.gui.magic_wand_healer_alt_forces_table, creative_mode_defines.names.gui
                        .magic_wand_healer_alt_force_name_checkbox_prefix,
    ...
    modifier = {
        ...
        contents = {
            ...
            alt_select_mode_container_name = creative_mode_defines.names.gui
                .magic_wand_modifier_alt_select_mode_container,
            ...
            ----
            create_select_mode_gui_function = function(player, container)
                create_common_elements_for_modifier(player, container,
                    magic_wand_modifier.get_std_ignore_player_characters, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_ignore_characters_checkbox,
                    magic_wand_modifier.get_std_ignore_healthess_entities, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_ignore_healthless_checkbox,
                    magic_wand_modifier.get_std_ignore_indestructible_entities, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_ignore_indestructible_checkbox, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_forces_label, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_forces_table, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_force_name_checkbox_prefix,
                    magic_wand_modifier.get_std_select_entities_on_force, creative_mode_defines.names.gui
                        .magic_wand_modifier_std_forces_select_all_button)
            end,
            ----
            create_alt_select_mode_gui_function = function(player, container)
                create_common_elements_for_modifier(player, container,
                    magic_wand_modifier.get_alt_ignore_player_characters, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_ignore_characters_checkbox,
                    magic_wand_modifier.get_alt_ignore_healthess_entities, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_ignore_healthless_checkbox,
                    magic_wand_modifier.get_alt_ignore_indestructible_entities, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_ignore_indestructible_checkbox, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_forces_label, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_forces_table, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_force_name_checkbox_prefix,
                    magic_wand_modifier.get_alt_select_entities_on_force, creative_mode_defines.names.gui
                        .magic_wand_modifier_alt_forces_select_all_button)
        ...
        for entity_name, data in pairs(sorted_entities) do
            ...
            if count > 0 then
                ...
                if item_name then
                    ...
                    button_tooltip = {"gui.creative-mode_item-on-ground-slot-tooltip", item_prototype.localised_name,
                    ...
                    label_name = creative_mode_defines.names.gui
                ...
                elseif ghosted_entity_name then
                    ...
                    button_tooltip = {"gui.creative-mode_ghost-entity-slot-tooltip", entity_prototype.localised_name,
                ...
                elseif ghosted_tile_name then
                    ...
                    button_style = creative_mode_defines.names.gui_styles.magic_wand_popup_ghost_slot_button
                    button_tooltip = {"gui.creative-mode_ghost-tile-slot-tooltip", tile_prototype.localised_name,
                                      {"gui.creative-mode_tile-name", ghosted_tile_name},
                                      {"gui.creative-mode_unit-number", get_string_for_info_array(unit_numbers, 10)}}
                    label_name =
                        creative_mode_defines.names.gui.magic_wand_modifier_popup_ghost_tile_count_label_prefix ..
                            ghosted_tile_name
                else
                    -- common entity
                    ...
                    button_tooltip = {"gui.creative-mode_entity-slot-tooltip", entity_prototype.localised_name,
                                      {"gui.creative-mode_entity-type", entity_prototype.type},
...
function gui_menu_magicwand.update_menu_accessibility_according_to_access_right_for_player(player,
            ...
            for _, data in pairs(gui_menu_magicwand.magic_wand_menus_gui_data) do
                if updated_access_right_codes[data.access_right_code] then
                    ...
                    if data.get_player_can_access_function(player) then
                        ...
                        local magic_wand_frame = magic_wand_menus_container[creative_mode_defines.names.gui
                                                     .magic_wand_frame]
...
local function deselect_currently_selected_tile_or_resource_slot_for_player_in_container(player, select_mode_container,
    tiles_table_name, tile_name_button_prefix, get_selected_tile_function, resources_table_name,
    resource_name_button_prefix, get_selected_resource_function)
...
local function on_gui_click_in_tiles_table(element, element_name, player, tiles_table_name,
    set_selected_tile_prototype_function, tile_name_button_prefix, tile_name_button_pattern, get_selected_tile_function,
    resources_table_name, resource_name_button_prefix, get_selected_resource_function)
    if element.parent and element.parent.name == tiles_table_name then
        ...
        if style.name == creative_mode_defines.names.gui_styles.tile_slot_selected then
            ...
            deselect_currently_selected_tile_or_resource_slot_for_player_in_container(player, select_mode_container,
                tiles_table_name, tile_name_button_prefix, get_selected_tile_function, resources_table_name,
                resource_name_button_prefix, get_selected_resource_function)
...
-- Returns whether the event is consumed and should no longer forward to other elements.
local function on_gui_click_in_resources_table(element, element_name, player, resources_table_name,
    set_selected_resource_prototype_function, resource_name_button_prefix, resource_name_button_pattern,
    get_selected_resource_function, tiles_table_name, tile_name_button_prefix, get_selected_tile_function)
...
local function update_resource_amount_slider_buttons_and_textfield_in_container(resource_amount_container,
    resource_amount, slider_button_name_prefix, slider_textfield_name)
    for i, value in ipairs(creator_resource_amount_slider_values) do
        local style
        if value <= resource_amount then
            style = creative_mode_defines.names.gui_styles.slider_button_on
...
-- Returns whether the event is consumed and should no longer forward to other elements.
local function on_gui_click_in_resource_amount_slider(element, element_name, player, slider_container_name,
    slider_button_name_prefix, slider_button_name_pattern, set_resource_amount_function, slider_textfield_name)
        ...
        if element.type == "button" then
            ...
            if button_index then
                ...
                if button_index and button_index >= 1 and button_index <= #creator_resource_amount_slider_values then
                    ...
                    -- Update the slider.
                    update_resource_amount_slider_buttons_and_textfield_in_container(element.parent, resource_amount,
                        slider_button_name_prefix, slider_textfield_name)
                end
            end
        end
        return true
...
local function on_gui_click_in_forces_table_select_all_button(element, element_name, player, select_all_button_name,
    set_force_function)
...
function gui_menu_magicwand.on_gui_click(element, element_name, player, button, alt, control, shift)
    ...
    if on_gui_click_in_tiles_table(element, element_name, player,
        creative_mode_defines.names.gui.magic_wand_creator_tiles_table, magic_wand_creator.set_selected_tile_prototype,
    ...
    if on_gui_click_in_resources_table(element, element_name, player,
        creative_mode_defines.names.gui.magic_wand_creator_resources_table,
        magic_wand_creator.set_selected_resource_prototype, creative_mode_defines.names.gui
            .magic_wand_creator_resource_name_button_prefix, creative_mode_defines.match_patterns.gui
            .magic_wand_creator_resource_name_button, magic_wand_creator.get_selected_resource_prototype,
    ...
    if on_gui_click_in_resource_amount_slider(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_creator_rsc_amt_slider_container, creative_mode_defines.names.gui
        .magic_wand_creator_rsc_amt_slider_button_prefix, creative_mode_defines.match_patterns.gui
        .magic_wand_creator_rsc_amt_slider_button, magic_wand_creator.set_resource_amount, creative_mode_defines.names
        .gui.magic_wand_creator_rsc_amt_slider_textfield) then
        -- Creator - resource amount slider button.
        return true
    end

    if on_gui_click_in_forces_table_select_all_button(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_creator_alt_forces_select_all_button, magic_wand_creator.set_alt_mode_apply_on_force) then
    ...
    if on_gui_click_in_tiles_table(element, element_name, player,
        ...
        creative_mode_defines.names.gui.magic_wand_creator_resources_table_2, creative_mode_defines.names.gui
            .magic_wand_creator_resource_name_button_2_prefix, magic_wand_creator.get_selected_resource_prototype_2) then
        -- Creator - tile slot 2.
        return true
    end
    ...
    if on_gui_click_in_resources_table(element, element_name, player,
        ...
        magic_wand_creator.set_selected_resource_prototype_2, creative_mode_defines.names.gui
            .magic_wand_creator_resource_name_button_2_prefix, creative_mode_defines.match_patterns.gui
            .magic_wand_creator_resource_name_button_2, magic_wand_creator.get_selected_resource_prototype_2,
        creative_mode_defines.names.gui.magic_wand_creator_tiles_table_2, creative_mode_defines.names.gui
            .magic_wand_creator_tile_name_button_2_prefix, magic_wand_creator.get_selected_tile_prototype_2) then
        -- Creator - resource slot 2.
        return true
    end

    if on_gui_click_in_resource_amount_slider(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_creator_rsc_amt_slider_container_2, creative_mode_defines.names.gui
        .magic_wand_creator_rsc_amt_slider_button_2_prefix, creative_mode_defines.match_patterns.gui
        .magic_wand_creator_rsc_amt_slider_button_2, magic_wand_creator.set_resource_amount_2,
    ...
    if on_gui_click_in_forces_table_select_all_button(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_healer_heal_forces_select_all_button, magic_wand_healer.set_heal_entities_on_force) then
        -- Healer - select all forces button for healing.
        return true
    end

    if on_gui_click_in_forces_table_select_all_button(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_healer_alt_forces_select_all_button, magic_wand_healer.set_alt_mode_apply_on_force) then
    ...
    if on_gui_click_in_forces_table_select_all_button(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_modifier_std_forces_select_all_button, magic_wand_modifier.set_std_select_entities_on_force) then
        -- Modifier - select all forces button for std mode.
        return true
    end

    if on_gui_click_in_forces_table_select_all_button(element, element_name, player, creative_mode_defines.names.gui
        .magic_wand_modifier_alt_forces_select_all_button, magic_wand_modifier.set_alt_select_entities_on_force) then
    ...
    if element_name == creative_mode_defines.names.gui.magic_wand_modifier_quick_action_remove_button then
        ...
        local action_index = string.match(action_container.name, creative_mode_defines.match_patterns.gui
                                 .magic_wand_modifier_quick_action_container)
    ...
    if element.parent and element.parent.name ==
        creative_mode_defines.names.gui.magic_wand_modifier_popup_entities_table then
        if element.type == "sprite-button" then
            ...
            check_and_remove_modifier_popup_slot_by_rules(element, element_name, player, {
                common_entity_rule = {
                    slot_name_match_pattern = creative_mode_defines.match_patterns.gui
                        .magic_wand_modifier_popup_entity_name_slot,
                    label_name_prefix = creative_mode_defines.names.gui
                        .magic_wand_modifier_popup_entity_count_label_prefix,
                ...
                item_on_ground_entity_rule = {
                    slot_name_match_pattern = creative_mode_defines.match_patterns.gui
                        .magic_wand_modifier_popup_item_on_ground_name_slot,
                    label_name_prefix = creative_mode_defines.names.gui
                        .magic_wand_modifier_popup_item_on_ground_count_label_prefix,
                ...
                ghost_entity_rule = {
                    slot_name_match_pattern = creative_mode_defines.match_patterns.gui
                        .magic_wand_modifier_popup_ghost_entity_name_slot,
                    label_name_prefix = creative_mode_defines.names.gui
                        .magic_wand_modifier_popup_ghost_entity_count_label_prefix,
                ...
                ghost_tile_rule = {
                    slot_name_match_pattern = creative_mode_defines.match_patterns.gui
                        .magic_wand_modifier_popup_ghost_tile_name_slot,
                    label_name_prefix = creative_mode_defines.names.gui
                        .magic_wand_modifier_popup_ghost_tile_count_label_prefix,
    ...
    local clicked, cheat_gui_data, applied_value = gui_menu_cheats.on_gui_click_in_cheats_menu_toggles(element,
                                                       element_name, player,
                                                       gui_menu_magicwand.modification_popup_cheats_gui_data,
            ...
            if container then
                ...
                if magic_wand_menus_container then
                    ...
                    if frame then
                        ...
                        -- Actions container.
                        actions_container = alt_select_mode_container[creative_mode_defines.names.gui
                                                .magic_wand_modifier_quick_actions_container]
                    end
                end
            end
...
local function on_gui_text_changed_in_resource_amount_slider_textfield(element, element_name, player, textfield_name,
    set_resource_amount_function, slider_button_name_prefix)
    if element_name == textfield_name then
        ...
        update_resource_amount_slider_buttons_and_textfield_in_container(resource_amount_container, resource_amount,
            slider_button_name_prefix, textfield_name)
        return true
    end
end
...
function gui_menu_magicwand.on_gui_text_changed(element, element_name, player)
    if on_gui_text_changed_in_resource_amount_slider_textfield(element, element_name, player,
        creative_mode_defines.names.gui.magic_wand_creator_rsc_amt_slider_textfield,
        magic_wand_creator.set_resource_amount, creative_mode_defines.names.gui
            .magic_wand_creator_rsc_amt_slider_button_prefix) then
        -- Creator - resource amount textfield.
        return true
    end
    ...
    if on_gui_text_changed_in_resource_amount_slider_textfield(element, element_name, player,
        creative_mode_defines.names.gui.magic_wand_creator_rsc_amt_slider_textfield_2,
        magic_wand_creator.set_resource_amount_2, creative_mode_defines.names.gui
            .magic_wand_creator_rsc_amt_slider_button_2_prefix) then
...
function gui_menu_magicwand.on_gui_checked_state_changed(element, element_name, player)
    ...
    if element.parent and element.parent.name == creative_mode_defines.names.gui.magic_wand_creator_alt_forces_table then
        ...
        local force_name = string.match(element.name, creative_mode_defines.match_patterns.gui
                               .magic_wand_creator_alt_force_name_checkbox)
        if force_name then
    ...
    if element.parent and element.parent.name == creative_mode_defines.names.gui.magic_wand_healer_heal_forces_table then
        ...
        local force_name = string.match(element.name, creative_mode_defines.match_patterns.gui
                               .magic_wand_healer_heal_force_name_checkbox)
        if force_name then
            local force = game.forces[force_name]
            if force then
    ...
    if element.parent and element.parent.name == creative_mode_defines.names.gui.magic_wand_healer_alt_forces_table then
        ...
        local force_name = string.match(element.name, creative_mode_defines.match_patterns.gui
                               .magic_wand_healer_alt_force_name_checkbox)
        if force_name then
            local force = game.forces[force_name]
            if force then
    ...
    if element.parent and element.parent.name == creative_mode_defines.names.gui.magic_wand_modifier_std_forces_table then
        ...
        local force_name = string.match(element.name, creative_mode_defines.match_patterns.gui
                               .magic_wand_modifier_std_force_name_checkbox)
        if force_name then
            local force = game.forces[force_name]
            if force then
    ...
    if element.parent and element.parent.name == creative_mode_defines.names.gui.magic_wand_modifier_alt_forces_table then
        ...
        local force_name = string.match(element.name, creative_mode_defines.match_patterns.gui
                               .magic_wand_modifier_alt_force_name_checkbox)
        if force_name then
            local force = game.forces[force_name]
            if force then
