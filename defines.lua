...
creative_mode_defines.empty_png.data = {filename = creative_mode_defines.empty_png.path, priority = "extra-high", width = 1, height = 1}
creative_mode_defines.empty_animation = {filename = creative_mode_defines.empty_png.path, priority = "extra-high", width = 1, height = 1, frame_count = 1}
...
creative_mode_defines.names.settings =
{
	...
	creative_cargo_wagon_contains_hidden_items	= creative_mode_defines.name_prefix .. "creative-cargo-wagon-contains-hidden-items",
	...
	enable_instant_deconstruction_by_default	= creative_mode_defines.name_prefix .. "enable-instant-deconstruction-by-default",
...
creative_mode_defines.names.entities =
{
	...
	active_electric_energy_interface_output	= creative_mode_defines.name_prefix .. "active-electric-energy-interface-output",
...
creative_mode_defines.names.gui =
{
	...
	personal_cheats_targets_inner_container			= creative_mode_defines.name_prefix .. "personal-cheats-targets-inner-container",
	personal_cheats_target_index_button_prefix		= creative_mode_defines.name_prefix .. "personal-cheats-target-index-button-",
	personal_cheats_targets_select_all_button		= creative_mode_defines.name_prefix .. "personal-cheats-targets-select-all-button",
	...
	personal_cheats_not_included_in_enable_all_note	= creative_mode_defines.name_prefix .. "personal-cheats-not-included-in-enable-all-note",
	...
	stack_inserter_capacity_bonus_container			= creative_mode_defines.name_prefix .. "stack-inserter-capacity-bonus-container",
	stack_inserter_capacity_bonus_label				= creative_mode_defines.name_prefix .. "stack-inserter-capacity-bonus-label",
	stack_inserter_capacity_bonus_textfield			= creative_mode_defines.name_prefix .. "stack-inserter-capacity-bonus-textfield",
	stack_inserter_capacity_bonus_separator			= creative_mode_defines.name_prefix .. "stack-inserter-capacity-bonus-separator",
	stack_inserter_capacity_bonus_apply_button		= creative_mode_defines.name_prefix .. "stack-inserter-capacity-bonus-apply-button",
	...
	team_cheats_not_included_in_enable_all_note		= creative_mode_defines.name_prefix .. "team-cheats-not-included-in-enable-all-note",
	...
	surface_cheats_targets_select_all_button		= creative_mode_defines.name_prefix .. "surface-cheats-targets-select-all-button",
	...
	evolution_pollution_factor_apply_button			= creative_mode_defines.name_prefix .. "evolution-pollution-factor-apply-button",
	...
	enemy_expansion_min_cooldown_apply_button		= creative_mode_defines.name_prefix .. "enemy-expansion-min-cooldown-apply-button",
	...
	enemy_expansion_max_cooldown_apply_button		= creative_mode_defines.name_prefix .. "enemy-expansion-max-cooldown-apply-button",
	...
	build_options_targets_select_all_button			= creative_mode_defines.name_prefix .. "build-options-targets-select-all-button",
	...
	magic_wand_creator_frame_title_container			= creative_mode_defines.name_prefix .. "magic-wand-creator-frame-title-container",
	...
	magic_wand_creator_select_mode_container			= creative_mode_defines.name_prefix .. "magic-wand-creator-select-mode-container",
	magic_wand_creator_select_mode_label				= creative_mode_defines.name_prefix .. "magic-wand-creator-select-mode-label",
	magic_wand_creator_alt_select_mode_container		= creative_mode_defines.name_prefix .. "magic-wand-creator-alt-select-mode-container",
	magic_wand_creator_alt_select_mode_label			= creative_mode_defines.name_prefix .. "magic-wand-creator-alt-select-mode-label",
	
	magic_wand_creator_correct_tiles_checkbox			= creative_mode_defines.name_prefix .. "magic-wand-creator-correct-tiles-checkbox",
	magic_wand_creator_dont_kill_by_tiles_checkbox		= creative_mode_defines.name_prefix .. "magic-wand-creator-dont-kill-by-tiles-checkbox",
	magic_wand_creator_tiles_table						= creative_mode_defines.name_prefix .. "magic-wand-creator-tiles-table",
	magic_wand_creator_tile_name_button_prefix			= creative_mode_defines.name_prefix .. "magic-wand-creator-tile-name-button-",
	magic_wand_creator_resources_table					= creative_mode_defines.name_prefix .. "magic-wand-creator-resources-table",
	magic_wand_creator_resource_name_button_prefix		= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-name-button-",
	magic_wand_creator_rsc_amt_slider_container			= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-container",
	magic_wand_creator_rsc_amt_slider_label				= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-label",
	magic_wand_creator_rsc_amt_slider_spacing_1			= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-spacing-1",
	magic_wand_creator_rsc_amt_slider_button_prefix		= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-button-",
	magic_wand_creator_rsc_amt_slider_spacing_2			= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-spacing-2",
	magic_wand_creator_rsc_amt_slider_textfield			= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-textfield",
	
	magic_wand_creator_use_pattern_container			= creative_mode_defines.name_prefix .. "magic-wand-creator-use-pattern-container",
	magic_wand_creator_use_pattern_label				= creative_mode_defines.name_prefix .. "magic-wand-creator-use-pattern-label",
	magic_wand_creator_use_pattern_drop_down			= creative_mode_defines.name_prefix .. "magic-wand-creator-use-pattern-drop-down",
	
	magic_wand_creator_tile_or_resource_2_container		= creative_mode_defines.name_prefix .. "magic-wand-creator-tile-or-resource-2-container",
	magic_wand_creator_tiles_table_2					= creative_mode_defines.name_prefix .. "magic-wand-creator-tiles-table-2",
	magic_wand_creator_tile_name_button_2_prefix		= creative_mode_defines.name_prefix .. "magic-wand-creator-tile-name-button-2-",
	magic_wand_creator_resources_table_2				= creative_mode_defines.name_prefix .. "magic-wand-creator-resources-table-2",
	magic_wand_creator_resource_name_button_2_prefix	= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-name-button-2-",
	magic_wand_creator_rsc_amt_slider_container_2		= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-container-2",
	magic_wand_creator_rsc_amt_slider_label_2			= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-label-2",
	magic_wand_creator_rsc_amt_slider_spacing_1_2		= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-spacing-1-2",
	magic_wand_creator_rsc_amt_slider_button_2_prefix	= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-button-2-",
	magic_wand_creator_rsc_amt_slider_spacing_2_2		= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-spacing-2-2",
	magic_wand_creator_rsc_amt_slider_textfield_2		= creative_mode_defines.name_prefix .. "magic-wand-creator-resource-amount-slider-textfield-2",
	
	magic_wand_creator_also_remove_decoratives_checkbox			= creative_mode_defines.name_prefix .. "magic-wand-creator-also-remove-decoratives-checkbox",
	magic_wand_creator_dont_remove_characters_checkbox			= creative_mode_defines.name_prefix .. "magic-wand-creator-dont-remove-characters-checkbox",
	magic_wand_creator_dont_remove_tiles_with_entities_checkbox	= creative_mode_defines.name_prefix .. "magic-wand-creator-dont-remove-tiles-with-entities-checkbox",
	magic_wand_creator_dont_kill_by_removing_tiles_checkbox		= creative_mode_defines.name_prefix .. "magic-wand-creator-dont-kill-by-removing-tiles-checkbox",
	...
	magic_wand_creator_alt_force_name_checkbox_prefix			= creative_mode_defines.name_prefix .. "magic-wand-creator-alt-force-name-checkbox-",
	magic_wand_creator_alt_forces_select_all_button				= creative_mode_defines.name_prefix .. "magic-wand-creator-alt-forces-select-all-button",
	
	magic_wand_healer_frame							= creative_mode_defines.name_prefix .. "magic-wand-healer-frame",
	magic_wand_healer_frame_title_container			= creative_mode_defines.name_prefix .. "magic-wand-healer-frame-title-container",
	...
	magic_wand_healer_select_mode_container			= creative_mode_defines.name_prefix .. "magic-wand-healer-select-mode-container",
	magic_wand_healer_select_mode_label				= creative_mode_defines.name_prefix .. "magic-wand-healer-select-mode-label",
	magic_wand_healer_alt_select_mode_container		= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-select-mode-container",
	magic_wand_healer_alt_select_mode_label			= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-select-mode-label",
	
	magic_wand_healer_revive_ghosts_checkbox			= creative_mode_defines.name_prefix .. "magic-wand-healer-revive-ghosts-checkbox",
	...
	magic_wand_healer_heal_force_name_checkbox_prefix	= creative_mode_defines.name_prefix .. "magic-wand-healer-heal-force-name-checkbox-",
	magic_wand_healer_heal_forces_select_all_button		= creative_mode_defines.name_prefix .. "magic-wand-healer-heal-forces-select-all-button",
	
	magic_wand_healer_alt_actions_container					= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-actions-container",
	magic_wand_healer_alt_set_hp_radiobutton				= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-set-hp-radiobutton",
	magic_wand_healer_alt_kill_radiobutton					= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-kill-radiobutton",
	magic_wand_healer_alt_dont_affect_characters_checkbox	= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-dont-affect-characters-checkbox",
	magic_wand_healer_alt_dont_affect_indestructible_checkbox = creative_mode_defines.name_prefix .. "magic-wand-healer-alt-dont-affect-indestructible-checkbox",
	...
	magic_wand_healer_alt_force_name_checkbox_prefix		= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-force-name-checkbox-",
	magic_wand_healer_alt_forces_select_all_button			= creative_mode_defines.name_prefix .. "magic-wand-healer-alt-forces-select-all-button",
	
	magic_wand_modifier_frame						= creative_mode_defines.name_prefix .. "magic-wand-modifier-frame",
	magic_wand_modifier_frame_title_container		= creative_mode_defines.name_prefix .. "magic-wand-modifier-frame-title-container",
	...
	magic_wand_modifier_select_mode_container		= creative_mode_defines.name_prefix .. "magic-wand-modifier-select-mode-container",
	magic_wand_modifier_select_mode_label			= creative_mode_defines.name_prefix .. "magic-wand-modifier-select-mode-label",
	magic_wand_modifier_alt_select_mode_container	= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-select-mode-container",
	magic_wand_modifier_alt_select_mode_label		= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-select-mode-label",
	
	magic_wand_modifier_std_ignore_characters_checkbox		= creative_mode_defines.name_prefix .. "magic-wand-modifier-std-ignore-characters-checkbox",
	magic_wand_modifier_std_ignore_healthless_checkbox		= creative_mode_defines.name_prefix .. "magic-wand-modifier-std-ignore-healthless-checkbox",
	magic_wand_modifier_std_ignore_indestructible_checkbox	= creative_mode_defines.name_prefix .. "magic-wand-modifier-std-ignore-indestructible-checkbox",
	...
	magic_wand_modifier_std_force_name_checkbox_prefix		= creative_mode_defines.name_prefix .. "magic-wand-modifier-std-force-name-checkbox-",
	magic_wand_modifier_std_forces_select_all_button		= creative_mode_defines.name_prefix .. "magic-wand-modifier-std-forces-select-all-button",
	
	magic_wand_modifier_alt_ignore_characters_checkbox		= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-ignore-characters-checkbox",
	magic_wand_modifier_alt_ignore_healthless_checkbox		= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-ignore-healthless-checkbox",
	magic_wand_modifier_alt_ignore_indestructible_checkbox	= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-ignore-indestructible-checkbox",
	...
	magic_wand_modifier_alt_force_name_checkbox_prefix		= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-force-name-checkbox-",
	magic_wand_modifier_alt_forces_select_all_button		= creative_mode_defines.name_prefix .. "magic-wand-modifier-alt-forces-select-all-button",
	magic_wand_modifier_quick_actions_label					= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-actions-label",
	magic_wand_modifier_quick_actions_container				= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-actions-container",
	magic_wand_modifier_quick_action_container_prefix		= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-action-container-",
	magic_wand_modifier_quick_action_remove_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-action-remove-button",
	magic_wand_modifier_quick_action_separator				= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-action-separator",
	magic_wand_modifier_quick_action_name_label				= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-action-name-label",
	magic_wand_modifier_quick_action_colon_label			= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-action-colon-label",
	magic_wand_modifier_quick_action_value_label			= creative_mode_defines.name_prefix .. "magic-wand-modifier-quick-action-value-label",
	magic_wand_modifier_remove_all_quick_actions_button		= creative_mode_defines.name_prefix .. "magic-wand-modifier-remove-all-quick-actions-button",
	
	magic_wand_modifier_popup_container							= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-container",
	magic_wand_modifier_popup_entities_frame					= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entities-frame",
	magic_wand_modifier_popup_entities_frame_title_container	= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entities-frame-title-container",
	magic_wand_modifier_popup_entities_frame_title_label		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entities-frame-title-label",
	magic_wand_modifier_popup_entities_frame_refresh_button		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entities-frame-refresh-button",
	magic_wand_modifier_popup_entities_sroll_pane				= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entities-scroll-pane",
	magic_wand_modifier_popup_entities_table					= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entities-table",
	magic_wand_modifier_popup_entity_name_slot_prefix			= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entity-slot-",
	magic_wand_modifier_popup_item_on_ground_name_slot_prefix	= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-item-on-ground-slot-",
	magic_wand_modifier_popup_ghost_entity_name_slot_prefix		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-ghost-entity-slot-",
	magic_wand_modifier_popup_ghost_tile_name_slot_prefix		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-ghost-tile-slot-",
	magic_wand_modifier_popup_entity_count_label_prefix			= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-entity-count-label-",
	magic_wand_modifier_popup_item_on_ground_count_label_prefix	= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-item-on-ground-count-label-",
	magic_wand_modifier_popup_ghost_entity_count_label_prefix	= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-ghost-entity-count-label-",
	magic_wand_modifier_popup_ghost_tile_count_label_prefix		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-ghost-tile-count-label-",
	
	magic_wand_modifier_popup_actions_frame						= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-actions-frame",
	magic_wand_modifier_popup_actions_frame_title_container		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-actions-frame-title-container",
	magic_wand_modifier_popup_actions_frame_title_label			= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-actions-frame-title-label",
	magic_wand_modifier_popup_actions_frame_close_button		= creative_mode_defines.name_prefix .. "magic-wand-modifier-popup-actions-frame-close-button",
	...
	magic_wand_modifier_destructible_container			= creative_mode_defines.name_prefix .. "magic-wand-modifier-destructible-container",
	magic_wand_modifier_destructible_label				= creative_mode_defines.name_prefix .. "magic-wand-modifier-destructible-label",
	magic_wand_modifier_destructible_on_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-destructible-on-button",
	magic_wand_modifier_destructible_off_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-destructible-off-button",
	...
	magic_wand_modifier_rotatable_container				= creative_mode_defines.name_prefix .. "magic-wand-modifier-rotatable-container",
	magic_wand_modifier_rotatable_label					= creative_mode_defines.name_prefix .. "magic-wand-modifier-rotatable-label",
	magic_wand_modifier_rotatable_on_button				= creative_mode_defines.name_prefix .. "magic-wand-modifier-rotatable-on-button",
	magic_wand_modifier_rotatable_off_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-rotatable-off-button",
	...
	magic_wand_modifier_operable_off_button				= creative_mode_defines.name_prefix .. "magic-wand-modifier-operable-off-button",
	
	magic_wand_modifier_full_health_container			= creative_mode_defines.name_prefix .. "magic-wand-modifier-full-health-container",
	magic_wand_modifier_full_health_label				= creative_mode_defines.name_prefix .. "magic-wand-modifier-full-health-label",
	magic_wand_modifier_full_health_on_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-full-health-on-button",
	magic_wand_modifier_full_health_off_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-full-health-off-button",
	
	magic_wand_modifier_backer_name_container			= creative_mode_defines.name_prefix .. "magic-wand-modifier-backer-name-container",
	magic_wand_modifier_backer_name_label				= creative_mode_defines.name_prefix .. "magic-wand-modifier-backer-name-label",
	magic_wand_modifier_backer_name_textfield			= creative_mode_defines.name_prefix .. "magic-wand-modifier-backer-name-textfield",
	magic_wand_modifier_backer_name_separator			= creative_mode_defines.name_prefix .. "magic-wand-modifier-backer-name-separator",
	magic_wand_modifier_backer_name_apply_button		= creative_mode_defines.name_prefix .. "magic-wand-modifier-backer-name-apply-button",
	
	magic_wand_modifier_to_be_looted_container			= creative_mode_defines.name_prefix .. "magic-wand-modifier-to-be-looted-container",
	magic_wand_modifier_to_be_looted_label				= creative_mode_defines.name_prefix .. "magic-wand-modifier-to-be-looted-label",
	magic_wand_modifier_to_be_looted_on_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-to-be-looted-on-button",
	magic_wand_modifier_to_be_looted_off_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-to-be-looted-off-button",
	...
	magic_wand_modifier_revive_apply_button				= creative_mode_defines.name_prefix .. "magic-wand-modifier-revive-apply-button",
	...
	magic_wand_modifier_destroy_apply_button			= creative_mode_defines.name_prefix .. "magic-wand-modifier-destroy-apply-button",
	...
	magic_wand_modifier_team_targets_drop_down_container= creative_mode_defines.name_prefix .. "magic-wand-modifier-team-targets-drop-down-container",
	magic_wand_modifier_team_current_button				= creative_mode_defines.name_prefix .. "magic-wand-modifier-team-current-button",
	magic_wand_modifier_team_targets_scroll_pane		= creative_mode_defines.name_prefix .. "magic-wand-modifier-team-targets-scroll-pane",
	magic_wand_modifier_team_targets_container			= creative_mode_defines.name_prefix .. "magic-wand-modifier-team-targets-container",
	magic_wand_modifier_team_targets_inner_container	= creative_mode_defines.name_prefix .. "magic-wand-modifier-team-targets-inner-container",
	magic_wand_modifier_team_target_name_button_prefix	= creative_mode_defines.name_prefix .. "magic-wand-modifier-team-target-name-button-",	
	...
	events_menu_search_textfield_placeholder_flow	= creative_mode_defines.name_prefix .. "events-menu-search-textfield-placeholder-flow",
	...
	interface_can_register_remote_function_label	= creative_mode_defines.name_prefix .. "interface-can-register-remote-function-label",
	...
	access_personal_cheat_admin_only_button			= creative_mode_defines.name_prefix .. "access-personal-cheat-admin-only-button",
	...
	access_surface_cheat_current_surface_button		= creative_mode_defines.name_prefix .. "access-surface-cheat-current-surface-button",
	...
	access_creator_magic_wand_inner_container		= creative_mode_defines.name_prefix .. "access-creator-magic-wand-inner-container",
	access_creator_magic_wand_admin_only_button		= creative_mode_defines.name_prefix .. "access-creator-magic-wand-admin-only-button",
	...
	access_healer_magic_wand_inner_container		= creative_mode_defines.name_prefix .. "access-healer-magic-wand-inner-container",
	access_healer_magic_wand_admin_only_button		= creative_mode_defines.name_prefix .. "access-healer-magic-wand-admin-only-button",
	...
	access_modifier_magic_wand_inner_container		= creative_mode_defines.name_prefix .. "access-modifier-magic-wand-inner-container",
	access_modifier_magic_wand_admin_only_button	= creative_mode_defines.name_prefix .. "access-modifier-magic-wand-admin-only-button",
	...
	overall_access_rights_admin_only_button			= creative_mode_defines.name_prefix .. "overall-access-rights-admin-only-button",
	...
	disable_creative_mode_permanently_button		= creative_mode_defines.name_prefix .. "disable-creative-mode-permanently-button",
	...
	configurable_super_boiler_set_temp_container	= creative_mode_defines.name_prefix .. "configurable-super-boiler-set-temp-container",
	configurable_super_boiler_set_temp_label		= creative_mode_defines.name_prefix .. "configurable-super-boiler-set-temp-label",
	configurable_super_boiler_set_temp_textfield	= creative_mode_defines.name_prefix .. "configurable-super-boiler-set-temp-textfield",
	configurable_super_boiler_set_temp_button		= creative_mode_defines.name_prefix .. "configurable-super-boiler-set-temp-button",
	...
	item_source_can_insert_to_vehicle_checkbox			= creative_mode_defines.name_prefix .. "item-source-can-insert-to-vehicle-checkbox",
	item_source_can_insert_to_player_checkbox			= creative_mode_defines.name_prefix .. "item-source-can-insert-to-player-checkbox",
	item_source_can_drop_on_ground_checkbox				= creative_mode_defines.name_prefix .. "item-source-can-drop-on-ground-checkbox",
	item_source_insert_to_player_frame					= creative_mode_defines.name_prefix .. "item-source-insert-to-player-frame",
	item_source_insert_only_once_to_player_checkbox		= creative_mode_defines.name_prefix .. "item-source-insert-only-once-to-player-checkbox",
	item_source_insert_once_to_player_frame				= creative_mode_defines.name_prefix .. "item-source-insert-once-to-player-frame",
	item_source_insert_once_to_player_container			= creative_mode_defines.name_prefix .. "item-source-insert-once-to-player-container",
	item_source_insert_once_to_player_amount_container	= creative_mode_defines.name_prefix .. "item-source-insert-once-to-player-amount-container",
	item_source_insert_once_to_player_amount_label		= creative_mode_defines.name_prefix .. "item-source-insert-once-to-player-amount-label",
	item_source_insert_once_to_player_amount_field		= creative_mode_defines.name_prefix .. "item-source-insert-once-to-player-amount-field",
	item_source_insert_once_to_player_by_stack_checkbox	= creative_mode_defines.name_prefix .. "item-source-insert-once-to-player-by-stack-checkbox",
	...
	duplicator_can_duplicate_in_vehicle_checkbox	= creative_mode_defines.name_prefix .. "duplicator-can-duplicate-in-vehicle-checkbox",
	duplicator_can_duplicate_in_player_checkbox		= creative_mode_defines.name_prefix .. "duplicator-can-duplicate-in-player-checkbox",
	...
	item_void_can_remove_from_vehicle_checkbox		= creative_mode_defines.name_prefix .. "item-void-can-remove-from-vehicle-checkbox",
	item_void_can_remove_from_player_checkbox		= creative_mode_defines.name_prefix .. "item-void-can-remove-from-player-checkbox",
	item_void_can_remove_from_ground_checkbox		= creative_mode_defines.name_prefix .. "item-void-can-remove-from-ground-checkbox",
...
creative_mode_defines.names.gui_captions =
{
	...
	creative_chest_display_mode_original		= {"gui.creative-mode_switch-inventory-display-mode", {"gui.creative-mode_inventory-display-mode-original"}},
	creative_chest_display_mode_compact			= {"gui.creative-mode_switch-inventory-display-mode", {"gui.creative-mode_inventory-display-mode-compact"}},
}
-- GUI element styles.
...
creative_mode_defines.match_patterns.gui =
{
	...
	personal_cheats_target_index_button					= creative_mode_defines.name_prefix_pattern .. "personal%-cheats%-target%-index%-button%-(%d+)",
	team_cheats_target_name_button						= creative_mode_defines.name_prefix_pattern .. "team%-cheats%-target%-name%-button%-(.+)",
	surface_cheats_target_name_button					= creative_mode_defines.name_prefix_pattern .. "surface%-cheats%-target%-name%-button%-(.+)",
	build_options_target_index_button					= creative_mode_defines.name_prefix_pattern .. "build%-options%-target%-index%-button%-(%d+)",
	build_team_target_name_button						= creative_mode_defines.name_prefix_pattern .. "build%-team%-target%-name%-button%-(.+)",
	magic_wand_creator_tile_name_button					= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-tile%-name%-button%-(.+)",
	magic_wand_creator_resource_name_button				= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-resource%-name%-button%-(.+)",
	magic_wand_creator_rsc_amt_slider_button			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-resource%-amount%-slider%-button%-(%d+)",
	
	magic_wand_creator_tile_name_button_2				= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-tile%-name%-button%-2%-(.+)",
	magic_wand_creator_resource_name_button_2			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-resource%-name%-button%-2%-(.+)",
	magic_wand_creator_rsc_amt_slider_button_2			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-resource%-amount%-slider%-button%-2%-(%d+)",
	
	magic_wand_creator_alt_force_name_checkbox			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-creator%-alt%-force%-name%-checkbox%-(.+)",
	magic_wand_healer_heal_force_name_checkbox			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-healer%-heal%-force%-name%-checkbox%-(.+)",
	magic_wand_healer_alt_force_name_checkbox			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-healer%-alt%-force%-name%-checkbox%-(.+)",
	magic_wand_modifier_std_force_name_checkbox			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-std%-force%-name%-checkbox%-(.+)",
	magic_wand_modifier_alt_force_name_checkbox			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-alt%-force%-name%-checkbox%-(.+)",
	magic_wand_modifier_quick_action_container			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-quick%-action%-container%-(%d+)",
	magic_wand_modifier_popup_entity_name_slot			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-popup%-entity%-slot%-(.+)",
	magic_wand_modifier_popup_item_on_ground_name_slot	= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-popup%-item%-on%-ground%-slot%-(.+)",
	magic_wand_modifier_popup_ghost_entity_name_slot	= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-popup%-ghost%-entity%-slot%-(.+)",
	magic_wand_modifier_popup_ghost_tile_name_slot		= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-popup%-ghost%-tile%-slot%-(.+)",
	magic_wand_modifier_team_target_name_button			= creative_mode_defines.name_prefix_pattern .. "magic%-wand%-modifier%-team%-target%-name%-button%-(.+)",	
...
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.creative_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.creative_provider_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.autofill_requester_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.duplicating_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.duplicating_provider_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.void_requester_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.void_storage_chest)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_loader)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.creative_cargo_wagon)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.duplicating_cargo_wagon)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.void_cargo_wagon)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_logistic_robot)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_construction_robot)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_roboport)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.fluid_source)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.fluid_void)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_boiler)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_cooler)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.configurable_super_boiler)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.heat_source)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.heat_void)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.item_source)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.duplicator)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.item_void)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.random_item_source)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.creative_lab)
...
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.energy_source)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.passive_energy_source)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.energy_void)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.passive_energy_void)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_electric_pole)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_substation)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.magic_wand_creator)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.magic_wand_healer)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.magic_wand_modifier)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_radar)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_radar_2)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.alien_attractor_small)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.alien_attractor_medium)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.alien_attractor_large)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_beacon)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_speed_module)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_effectivity_module)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_productivity_module)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_clean_module)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_slow_module)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_consumption_module)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_pollution_module)

table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.belt_immunity_equipment)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_fusion_reactor_equipment)
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names, creative_mode_defines.names.items.super_personal_roboport_equipment)
