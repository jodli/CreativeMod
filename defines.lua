...
creative_mode_defines.names.gui_captions = {
    ...
    creative_chest_display_mode_original = {"gui.creative-mode_switch-inventory-display-mode",
                                            {"gui.creative-mode_inventory-display-mode-original"}},
    creative_chest_display_mode_compact = {"gui.creative-mode_switch-inventory-display-mode",
...
table.insert(creative_mode_defines.values.creative_provider_chest_additional_content_names,
