...
local events_menu_frame_caption_label_width = events_menu_frame_width - default_horizontal_spacing - search_textfield_width - default_horizontal_spacing - frame_caption_button_width
...
default_style[creative_mode_defines.names.gui_styles.main_menu_open_button] =
{
	...
	default_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 0, big_button_width_height * 0, big_button_width_height, big_button_width_height),
	hovered_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 1, big_button_width_height * 0, big_button_width_height, big_button_width_height),
	clicked_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 2, big_button_width_height * 0, big_button_width_height, big_button_width_height),
	disabled_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 3, big_button_width_height * 0, big_button_width_height, big_button_width_height),
}
...
default_style[creative_mode_defines.names.gui_styles.magic_wand_slider_label] =
{
	type = "label_style",
	parent = "label",
	width = cheat_width - default_horizontal_spacing - (slider_button_width * 13) - default_horizontal_spacing - slider_textfield_width - default_horizontal_spacing,
	scalable = false
}
...
default_style[creative_mode_defines.names.gui_styles.creative_chest_item_group_label] =
{
	type = "label_style",
	parent = "label",
	width = (inventory_slot_width * 10 + 1 * 9) - (creative_chest_item_group_left_right_button_width * 2 + creative_chest_item_group_number_label_width),
	scalable = false
}
...
default_style[creative_mode_defines.names.gui_styles.creative_chest_display_mode_button_original] =
{
	type = "button_style",
	parent = creative_mode_defines.names.gui_styles.entity_open_button,
	default_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 0, big_button_width_height * 2, big_button_width_height, big_button_width_height),
	hovered_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 1, big_button_width_height * 2, big_button_width_height, big_button_width_height),
	clicked_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 2, big_button_width_height * 2, big_button_width_height, big_button_width_height),
	disabled_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 3, big_button_width_height * 2, big_button_width_height, big_button_width_height),
}
...
default_style[creative_mode_defines.names.gui_styles.creative_chest_display_mode_button_compact] =
{
	type = "button_style",
	parent = creative_mode_defines.names.gui_styles.entity_open_button,
	default_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 0, big_button_width_height * 3, big_button_width_height, big_button_width_height),
	hovered_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 1, big_button_width_height * 3, big_button_width_height, big_button_width_height),
	clicked_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 2, big_button_width_height * 3, big_button_width_height, big_button_width_height),
	disabled_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 3, big_button_width_height * 3, big_button_width_height, big_button_width_height),
}
...
default_style[creative_mode_defines.names.gui_styles.inventory_toggle_all_button] =
{
    type = "button_style",
	parent = creative_mode_defines.names.gui_styles.entity_open_button,
	default_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 0, big_button_width_height * 1, big_button_width_height, big_button_width_height),
	hovered_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 1, big_button_width_height * 1, big_button_width_height, big_button_width_height),
	clicked_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 2, big_button_width_height * 1, big_button_width_height, big_button_width_height),
	disabled_graphical_set = extract_monolith("big-buttons.png", big_button_width_height * 3, big_button_width_height * 1, big_button_width_height, big_button_width_height),
	left_click_sound =
	{
		{
			filename = "__core__/sound/gui-click.ogg",
