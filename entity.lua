...
local function electric_energy_interface(entity_name, item_name, icon_name, animation_filename, usage_priority,
    default_input_flow, default_output_flow, default_production, default_usage, additional_pastable_entities)
    return {
...
-- Super Roboport
{
    ...
    circuit_connector_sprites = circuit_connector_definitions[creative_mode_defines.names.entities.super_roboport]
        .sprites,
    circuit_wire_max_distance = 1000,
